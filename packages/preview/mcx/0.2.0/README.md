...
<summary>Example</summary>
  <img src="https://github.com/1zumiSagiri/mcx/blob/v0.2.0/docs/images/quick_start_example.png" alt="Quick Start Example" width="600px" />
</details>
...
See [`tests/example.typ`](https://github.com/1zumiSagiri/mcx/blob/v0.2.0/tests/example.typ) for a complete example.
...
The full documentation is available in the [manual](https://github.com/1zumiSagiri/mcx/blob/v0.2.0/docs/manual.pdf).
