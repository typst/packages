...
#let ziti = (
  ...
  songti: ("Times New Roman", "SimSun", "Songti SC", "STSongti"),
  // 黑体，属于「无衬线字体」，一般可以等同于英文中的 Sans Serif Font
  // 这一行分别是「新罗马体（有衬线英文字体）」、「黑体（Windows）」、「黑体（MacOS）」、「华文黑体」
  heiti: ("Times New Roman", "SimHei", "Heiti SC", "STHeiti"),
  // 楷体
  // 这一行分别是「新罗马体（有衬线英文字体）」、「锴体（Windows）」、「楷体（MacOS）」、「华文黑体」、「方正楷体」
  kaiti: ("Times New Roman", "KaiTi", "Kaiti SC", "STKaiti", "KaiTi_GB2312"),
  // 仿宋
  // 这一行分别是「新罗马体（有衬线英文字体）」、「方正仿宋」、「仿宋（Windows）」、「仿宋（MacOS）」、「华文仿宋」
  fangsong: ("Times New Roman", "FangSong_GB2312", "FangSong", "FangSong SC", "STFangSong"),
