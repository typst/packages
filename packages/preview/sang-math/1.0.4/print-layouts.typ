...
#let layout-draft(
  ...
  set page(
    ...
    background: context {
      ...
      place(top + left, dx: draft-x, rect(
        width: draft-width,
      ...
      place(top + left, dx: label-x, dy: top-margin, rotate(90deg, text(
        size: 7.5pt,
      ...
      for index in range(line-count) {
        place(top + left, dx: draft-x + 6pt, dy: top-margin + index * line-gap, line(
