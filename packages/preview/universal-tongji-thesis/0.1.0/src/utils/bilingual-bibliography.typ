...
#import "./style.typ": 字号
#import "zh-aio.typ":*
#import "custom-heading.typ":header
#let bilingual-bibliography(
  ...
  // set text(size: zh(5), font: fts.song, lang: "zh")
  set text(size: zh(5), font: ("Times New Roman", "SimSun"), lang: "zh", top-edge: "cap-height", bottom-edge: "baseline")
  v(8pt)
  set par(leading: 9pt, spacing:9pt)
  bibliography(title: none, full: false, style: style)
}
