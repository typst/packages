...
#let bachelor-cover(
  ...
  let info-value(size: 字号.四号, key, body) = {
    ...
    rect(
      ...
      text(font: fonts.at(info-value-font, default: "宋体"), size: size, weight: "bold", bottom-edge: "descender", body),
    )
  }
  ...
  let info-title-value(size: 字号.一号, body) = {
    ...
    underline(
      offset: 6pt,
      stroke: 1.25pt,
      text(font: fonts.at(info-value-font, default: "宋体"), size: size, weight: "bold", bottom-edge: "baseline", body),
    )
  }
  ...
  stack(dir: ttb, spacing: 1fr, block(width: title-line-length * 1.5)[
    #stack(
      dir: ttb,
      spacing: 12pt,
