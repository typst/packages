...
#let heading-conf(
  ...
  // 标题的上边距和下边距
  heading-top-margin: (0.96em, 0cm, 0cm),
  heading-bottom-margin: (0.6em, 0cm, 0cm),
  // 标题的固定缩进量
  ...
  heading-text: (
    ...
    (font: ziti.黑体, size: zihao.四号, weight: "regular"),
    (font: ziti.宋体, size: zihao.小四, weight: "regular")
  ),
