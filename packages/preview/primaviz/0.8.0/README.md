...
A pair of helper scripts (Python and TypeScript) convert CSS design-token files (Tailwind, shadcn, etc.) into primaviz themes. They live in the repo but are not shipped with the package — see [CONTRIBUTING.md](https://github.com/phiat/primaviz/blob/v0.8.0/CONTRIBUTING.md#extracting-themes-from-css) for usage.
...
For local dev setup, project structure, and helper scripts, see [CONTRIBUTING.md](https://github.com/phiat/primaviz/blob/v0.8.0/CONTRIBUTING.md).
