...
#let nutrition-label-nam(
  ...
  // Use the renamed parameter in the scale() function call.
  scale(scale-factor, origin: top + left)[
    #block[
      // Set styling for everything inside this block.
      #set text(font: font)
      #set par(leading: 0.4em)
      #set block(spacing: 0.5em)

      // The main container for the nutrition label.
      #rect(
        width: 3in,
        stroke: 1pt,
        inset: (x: 6pt, y: 6pt),
