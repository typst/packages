...
```typ
typst init @preview/clean-uoft-thesis:0.1.1 my-thesis
```
...
This template allows figures, tables, and plates to have separate captions and outline entries (descriptors in the List of Figures, List of Tables, and List of Plates).
This functionality was achieved by adapting the following code snippet by user /u/Andrew from the typst forums: https://forum.typst.app/t/how-do-i-customize-outline-entries-it-inner-it-body/3591/7.
To display separate text in the caption of a figure, table, or plate from its outline entry:

1. Ensure that the template is imported in the file containing that figure, table, or plate

`#import "@preview/clean-uoft-thesis:0.1.1": *`

2. Construct your caption using the `multicaption` function as follows:
