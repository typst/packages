...
#let project(
  ...
  acknowledgements: "",
  // Optional acronym-list content
  // If not given, the page for the acronym list will not appear
  acronyms: none,
  // Optional declaration describing the use of generative AI tools
  // If given, it is included in the final declaration of authorship
  ai-declaration: "",
  ...
  if acronyms != none {
    front-section(l.at("acronyms"), acronyms)
  }
  ...
  pagebreak()
  if lay.for-print { pagebreak() }
  let declaration-heading = if ai-declaration == "" {
    l.at("declaration-title")
  } else {
    l.at("ai-declaration-title")
  }
  heading(level: 1, numbering: none, declaration-heading)
