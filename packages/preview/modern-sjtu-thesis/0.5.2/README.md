...
This is the Typst template for degree theses at Shanghai Jiao Tong University, which can efficiently and continuously generate PDF format graduation theses. It currently supports the writing of undergraduate, master's, and doctoral theses, all developed with reference to the official Word templates provided.
...
你需要手动下载 [fonts.zip](https://github.com/tzhtaylor/modern-sjtu-thesis/releases/download/v0.5.2/fonts.zip) 然后手动上传 fonts 文件夹到项目中，否则会**导致字体显示错误**！
