...
#import "./packages.typ": (
  ...
  quati-abnt.academic_work.components.print_person, quati-abnt.bibliography.cite_prose,
  ...
  quati-abnt.common.components.source_for_content_created_by_authors, quati-abnt.note.closed_discussion_note,
