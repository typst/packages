...
```typ
#import "@preview/unofficial-sorbonne-presentation:0.3.0": sorbonne-template, slide
...
### For IPLESP
```typ
#import "@preview/unofficial-sorbonne-presentation:0.3.0": iplesp-template, slide
