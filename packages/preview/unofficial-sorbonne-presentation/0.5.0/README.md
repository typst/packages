...
```typ
#import "@preview/unofficial-sorbonne-presentation:0.5.0": sorbonne-template, slide
...
### For IPLESP
```typ
#import "@preview/unofficial-sorbonne-presentation:0.5.0": iplesp-template, slide
...
### For AP-HP
```typ
#import "@preview/unofficial-sorbonne-presentation:0.5.0": aphp-template, slide
