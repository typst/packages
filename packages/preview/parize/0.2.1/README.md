...
- See [ex-in-elems-test.typ](https://github.com/tianyi-smile/parize/blob/15d7b2a521ea7afa4e6c22f6b47ef0b712f912bb/tests/ex-in-elems-test.typ) for details on using `par-indent` with the `rect` element when `Paragraph Indentation` or `Paragraph Spacing` is enabled.
- See also [inlinable-block.pdf](https://github.com/tianyi-smile/parize/blob/15d7b2a521ea7afa4e6c22f6b47ef0b712f912bb/examples/inlinable-block.pdf) ([source](https://github.com/tianyi-smile/parize/blob/15d7b2a521ea7afa4e6c22f6b47ef0b712f912bb/examples/inlinable-block.typ)) for details on using `par-indent` with custom block-level containers that can be treated as part of a paragraph.
