...
#show: cogsci.with(
  ...
  author-info: format-authors(
    ...
    affiliations: (
      (super: [1], affil: [Department of Psychology, University of Wisconsin--Madison]),
      (super: [2], affil: [Department of Educational Psychology, University of Wisconsin--Madison]),
    ),
  ),
  abstract: [
    Include no author information in the initial submission, to facilitate blind review. AI tools cannot be listed as authors, and authors retain full responsibility for the accuracy, integrity, and originality of all content in their manuscripts. This includes verifying factual claims, ensuring proper attribution of ideas, and confirming that the work meets standards for academic integrity and does not contain plagiarized content. See the Acknowledgement section of the template for AI use declaration and acknowledgement. The abstract should be one paragraph, no more than 150~words, indented 1/8~inch on both sides, in 9~point font with single spacing. The heading "*Abstract*" should be 10~point, bold, centered, with one line of space below it. This one-paragraph abstract section is required only for standard proceedings papers. Following the abstract should be a blank line, followed by the header "*Keywords:*" and a list of descriptive keywords separated by semicolons, all in 9~point font, as shown below.
  ],
  keywords: (
...
The paper can be no longer than six pages plus an unlimited number of pages for references in the *initial submission*. In the *final submission*, the text of the paper, including an author line, must fit on six pages. An unlimited number of pages can be used for acknowledgements and references.
...
Use standard APA citation format. Citations within the text should include the author's last name and year. If the authors' names are included in the sentence, place only the year in parentheses, as in #cite(<NewellSimon1972>, form: "prose"), but otherwise place the entire reference in parentheses with the authors and year separated by a comma @NewellSimon1972. Use the "et~al." construction for works with three or more authors. List multiple references alphabetically and separate them by semicolons @Baker2007 @NewellSimon1972.
...
In the *initial submission*, please only include acknowledgements of AI use and no other acknowledgements to preserve anonymity. Regarding AI use: Authors may use AI tools when developing their projects and preparing their manuscripts, but such use must be described, transparently and in detail, in either the Methods or Acknowledgements section, as appropriate. Tools that are used to improve spelling, grammar, and general editing are not included in the scope of these guidelines. In the *final submission*, place acknowledgments (including human and AI contributions, and funding information) in a section *at the end of the paper*.
...
Use a first level section heading, "*References*", as shown below. Use a hanging indent style, with the first line of the reference flush against the left margin and subsequent lines indented by 1/8~inch. Below are example references for a conference paper, book chapter, dissertation, book, technical report, edited volume, and journal article, respectively.


#cite(<Baker2007>, form: none)
#cite(<Feigenbaum1963>, form: none)
#cite(<Matlock2001>, form: none)
#cite(<NewellSimon1972>, form: none)
#cite(<OhlssonLangley1985>, form: none)
#cite(<Sun2023>, form: none)
#cite(<TillmanWalker2022>, form: none)
