...
// through theme.typ's `#import "@preview/touying:0.7.4": *`
...
#import "@preview/touying:0.7.4": alternatives, meanwhile, only, uncover
#import "@preview/touying:0.7.4": utils  // Includes slide-counter and other utilities
