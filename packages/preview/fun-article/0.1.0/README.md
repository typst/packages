...
Fun Article is a compact two-column article template for Typst. It provides a drop-cap abstract, structured authors and affiliations, ORCID badges, running headers, page totals, and an optional significance note.
...
```sh
typst init @preview/fun-article:0.1.0
```

Or import it in an existing document:

```typ
#import "@preview/fun-article:0.1.0": appendix, fun-article
...
- `abstract`: Abstract text or content.
