...
// --- custom callout ---
#let def(title, endpoint: false, body) = callout(title: title, icon: "📖", color: accent, endpoint: endpoint, body)
#let prop(title, endpoint: false,  body) = callout(title: title, icon: "📌", color: night-color.lighten(45%), endpoint: endpoint, body)
#let important(title, endpoint: false, body) = callout(title: title, icon: text(font: "Twitter Color Emoji")[⚠️], color: warning, endpoint: endpoint, body)
#let example(title, endpoint: true, body) = callout(title: title, icon: "📝", color: example-color, endpoint: endpoint, body)
#let proof(title, endpoint: true, body) = callout(title: title, icon: text(font: "Twitter Color Emoji")[📏], color: danger, endpoint: endpoint, body)
