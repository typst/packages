...
See the [example.pdf](https://github.com/talal/ilm/blob/v2.1.0/example.pdf) file to see how it looks.
...
The list below shows a _brief description_ for each option. For a detailed explanation of these options, see the [example.pdf](https://github.com/talal/ilm/blob/v2.1.0/example.pdf) file.
