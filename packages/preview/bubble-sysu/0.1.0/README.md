...
Install required fonts from links below.
...
This package's code, documentation, and template files are licensed under the MIT No Attribution License (MIT-0). See [LICENSE](LICENSE) for details.

The Sun Yat-sen University logo SVG is not covered by MIT-0. It is part of Sun Yat-sen University's official VI system and remains subject to the [official VI documentation](https://home3.sysu.edu.cn/sysuvi/content):

> 申明：中山大学对本 VI 系统拥有专有权，任何单位和个人擅自转作其他商业用途或抄袭，均为侵权行为。我校将追究侵权者的法律责任。

The logo is included only for use consistent with Sun Yat-sen University's official VI documentation and must not be reused, copied, or used for other commercial purposes without permission.
