...
#figure(
  image("assets/THA_Logo.png", width: 50%),
  caption: "Das Logo der Technischen Hochschule Augsburg.",
)
...
#figure(
  grid(
    columns: 2,
    gutter: 5%,
    image("assets/THA_Logo.png"), image("assets/THA_Logo.png"),
  ),
  caption: "Zwei Bilder nebeneinander dargestellt.",
)
