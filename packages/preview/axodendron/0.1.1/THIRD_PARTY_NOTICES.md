...
No other downloaded NeuroMorpho.Org SWC is committed, packaged, or uploaded as a build artifact. The 30-case regression corpus remains checksum-pinned metadata plus a private local cache as described in the real-data policy section of [`docs/documentation.typ`](docs/documentation.typ).
