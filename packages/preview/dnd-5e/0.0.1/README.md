...
This package has been heavily inspired by the awesome work done by the *rpgTex* team on their [DND-5e-LaTeX-Template](https://github.com/rpgtex/DND-5e-LaTeX-Template).
