...
/// ```
/// -> content
#let theorem = _styled_environment.with(kind: context i18n.translate("Theorem"), emphasized: true)
...
#let definition = _styled_environment.with(kind: context i18n.translate("Definition"))
