# Naif's Islamic Research Toolkit
...
```typ
#import "@preview/naifs-islamic-research-toolkit:0.1.0": quran, set-qiraa, set-bracket
// Or for Arabic API
#import "@preview/naifs-islamic-research-toolkit:0.1.0": قرآن, ضبط-القراءة, تفعيل-الأقواس
```
