...
#import "@preview/touying-simpl-cnu:0.0.2": *
...
#show: cnu-theme.with(
  ...
  // Basic information
  config-info(
    title: [基于 Touying 的首都师范大学 Typst 幻灯片模板 \ 源自 touying-buaa],
    short-title: [基于 Touying 的首都师范大学 Typst 幻灯片模板],
    subtitle: [Typst Slide Theme for Capital Normal University Based on Touying],
...
#slide[
  ...
  - 本模板在 #link("https://github.com/maxchang3/touying-simpl-cnu") 维护，欢迎关注与贡献。
]
