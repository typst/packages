...
/// - language (en, es, de, fr, pt, it): Language of docuemnt. English, Spanish, German, Portuguese and Italian are defined.
///     Ejemplo buy bonito:
...
/// - show-student-data(none, true, false, "first-page", "odd-pages"): It shows a box for the student to enter their details. It can appear on the first page or on all odd-numbered pages.
