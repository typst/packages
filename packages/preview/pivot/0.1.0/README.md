...
<table align="center">
  <tr>
    <td align="center" valign="top">
      <img src="https://raw.githubusercontent.com/cybermallard/typst-pivot/v0.1.0/docs/img/tcp-header.png" height="260" alt="packet: a TCP header, narrow flags as leader callouts"><br>
      <sub><b>packet</b> · protocol header</sub>
    </td>
    <td align="center" valign="top">
      <img src="https://raw.githubusercontent.com/cybermallard/typst-pivot/v0.1.0/docs/img/struct-malware-c2.png" height="260" alt="struct: a malware C2 config as a memory map"><br>
      <sub><b>struct</b> · memory map</sub>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center" valign="top">
      <img src="https://raw.githubusercontent.com/cybermallard/typst-pivot/v0.1.0/docs/img/hexdump-gh0st.png" width="100%" alt="hexdump: a Gh0st RAT C2 header annotated"><br>
...
![pivot's colour-blind-safe palette](https://raw.githubusercontent.com/cybermallard/typst-pivot/v0.1.0/docs/img/palette.png)
...
[`examples/`](https://github.com/cybermallard/typst-pivot/tree/v0.1.0/examples) has a
