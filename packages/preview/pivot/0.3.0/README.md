...
![pivot's colour-blind-safe palette](https://raw.githubusercontent.com/cybermallard/typst-pivot/v0.3.0/docs/img/palette.png)
...
[`examples/`](https://github.com/cybermallard/typst-pivot/tree/v0.3.0/examples) has a
