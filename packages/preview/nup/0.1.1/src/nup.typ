...
#let nup(layout, pages, gutter: 0.1cm, shadow: true, 
         shadow-args: (:), rect-args: (:), page-args: (:)) = {

  let  default-page = (paper:"a4", margin:1cm, flipped:true, background: rect(width:100%, height:100%, fill: luma(95%)))
