...
Another useful concept is the glossary (especially if your thesis is longer). A glossary contains a list of abbreviations, acronyms, etc. In standard fashion, an abbreviation needs to be established in its long version before it can be used. The Glossarium package has a lot of features that might be useful and others that might be overkill, you can read about them on #link("https://typst.app/universe/package/glossarium/")[the package site].
