...
// set only-labled with true to ignore equation without label
#show math.equation: i-equation.show-equation.with(numbering: "(1.1)", only-labeled: true)
...
Unnumbered with `only-labeled: true`:
