#import "@preview/std-sjtu-master-midterm-report:0.1.0": *

// ======================================================
//                 填写说明 (Instructions)
// ======================================================
// 
// 1. [degree-program] 学生类别 (请填写对应字母 "a" / "p"): 
//    "a" -> 学术型硕士生 Academic Master
//    "p" -> 专业型硕士生 Professional Master
// 
// 2. [study-mode] 学习形式 (请填写对应字母 "f" / "p"): 
//    "f" -> 全日制 Full-time
//    "p" -> 非全日制 Part-time
//
// 3. [thesis-title] 论文题目: 
...
#show: body => project(
  ...
  // --- 正文开头的特制表格 (Thesis & Project) ---
  thesis-title: "我的很长很长很长很长很长很长很长很长很长很长很长很长很长很长的\n很厉害的论文题目",
  source-of-research-project: (1, 3, 5),
  thesis-proposal-date: "2026-01-01",
...
= 报告正文 Report。#text(weight: "regular", size: 12pt)[请阐述开题报告以来学位论文研究工作的进展情况及所取得的阶段性成果，并简述下一阶段研究计划，不少于4000汉字。Please summarize your research progress and achievements since your thesis proposal as well as your plan for next step. No less than 3200 words if written in English.]

制作本中期报告 Typst 模板的初衷，是为校友们提供一个比 LaTeX 更轻量、比 Word 更专业的排版方案。

== 模板使用指南 (Template Guide)

本模板已针对上海交通大学中期检查报告的格式规范，深度定制了字体、间距、标题悬挂缩进及参考文献样式。
...
= 成果清单 List of Achievements。#text(weight: "regular", size: 12pt)[请列出开题报告以来或上次年度进展报告以来新发表的学术论文、授权专利、国际会议论文、专著等成果清单。作者、标题、杂志、卷、期、页码等信息请填写完整。Please provide a list of academic publications (papers, patents, international academic conference talks/presentations, monographs, etc.) since your thesis proposal. Information on author list, title, journal name, volume, number, and pages shall be complete.]
