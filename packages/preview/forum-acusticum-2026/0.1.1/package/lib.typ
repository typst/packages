...
#let fa2026(
  ...
  bibliography: none,
  // Annoying disclaimer to use the correct font
  correct-font: true,  // TODO: Set default to false for next FA
  // The paper's content.
  body,
) = {
  ...
  place(
    ...
    clearance: -22pt,
    {
      ...
      review_notice
      if correct-font != true{
        text(2.5em, red)[#linebreak()Download and import the required font, then set the `correct-font` option of the FA package to `true`]
      }
    },
  )
