...
/// - palette: Array of shape keywords or literal-glyph characters, or `auto` for the library default.
...
///
/// The mapped column holds shape keywords accepted by `geom-point` (`"circle"`, `"square"`, `"triangle"`, `"diamond"`, `"cross"`, `"x"`, `"star"`, `"triangle-down"`); any other value renders as a literal glyph.
///
...
///
/// - n-breaks: Number of bins to partition the continuous domain into. Ignored when `breaks` is set.
