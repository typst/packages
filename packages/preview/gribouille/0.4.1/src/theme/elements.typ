...
/// - stroke: Outline thickness. Either an absolute Typst length (e.g., `1pt`), a ratio (e.g., `80%`) scaling the parent surface stroke, or `none` for no outline. Ratios with no absolute ancestor resolve against the default thickness.
