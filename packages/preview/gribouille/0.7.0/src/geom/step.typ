...
/// - arrow: Arrowhead spec built with `arrow`, marking the direction of each group's staircase. The head sits at the end of the whole path, not at every tread. `none` draws no head.
