...
/// - arrow: Arrowhead spec built with `arrow`, marking the direction of each group's line. The head sits at the end of the whole line, not at every join. `none` draws no head.
...
///
/// See also: `geom-point`, `geom-smooth`, `scale-discrete`, `aes`.
///
