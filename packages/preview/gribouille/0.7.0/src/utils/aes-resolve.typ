...
/// - params: The layer's resolved parameters, providing `<channel>`. The layer itself is deliberately not taken: a per-row call reaches every row through it, and costs time proportional to their number.
