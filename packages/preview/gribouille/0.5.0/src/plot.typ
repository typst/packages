...
/// - scales: Aesthetic-keyed scale overrides built with`scales` (e.g., `scales(x: scale-continuous(), colour: scale-viridis-d())`), or the dictionary returned by`expand-limits`.
...
/// - labels: Labels dictionary built with`labels` (title, subtitle, caption, axis titles).
...
///
/// See also: `aes`, `geom-point`, `coord-cartesian`, `facet-wrap`, `theme-grey`, `labels`.
///
