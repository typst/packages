...
///
/// Sets the per-axis `transform` so the trained scale's view is warped at mapping time. Accepts the same keywords as `scale-continuous`'s `transform:` parameter: `"identity"`, `"log10"`, `"sqrt"`, `"reverse"`.
///
