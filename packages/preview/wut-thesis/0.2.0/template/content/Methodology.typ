...
#figure(
image("../images/cat1.png", width: 60%), caption: flex-caption([Beautiful cat named Miss Moneypenny],[Picture of Miss Moneypenny])
)<MissMoneypenny>

- James Bond: male, ragdoll, 11 years
#figure(
image("../images/cat2.svg", width: 60%), caption: flex-caption([Charming cat named James Bond],[Picture of James Bond])
)<JamesBond>

- Calcipher: male, oriental short hair, 4 months
#figure(
image("../images/cat3.png", width: 60%), caption: flex-caption([Adorable kitten named Calcipher],[Picture of Calcipher])
)<Calcipher>

- Mei: female, oriental short hair, 4 months
  
#figure(
    image("../images/cat4.png", width: 60%), caption: flex-caption([Cute kitten named Mei],[Picture of Mei])
    )<Mei>
