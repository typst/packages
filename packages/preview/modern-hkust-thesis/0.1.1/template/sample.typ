// #import "lib/lib.typ": thesis, legend
#import "@preview/modern-hkust-thesis:0.1.1": thesis, legend
...
#show: thesis.with(
  ...
  acronym-col: 2, // the columns of list of abbreviations
...
#legend[
  Here is legend for this figure. You can write something here. Even more, you can add a grid here. like this: \
  #grid(
