...
#show: basic-academic-letter.with(
  ...
  per-name: "Dr XXX",
  per-homepage: "https://www.sist.tsinghua.edu.cn/sisten/Faculty.htm",
  per-title: "Professor",
  per-school: "School of Information Science and Technology",
  per-university: "Tsinghua University",
  per-email: "xxx@tsinghua.edu.cn",
