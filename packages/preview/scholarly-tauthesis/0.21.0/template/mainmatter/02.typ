...
#figure(
    grid(
        ...
        #tauthesis.subfigure(
            ...
            alt: "A subfigure showcasing a conic gradient or color progression in rainbow color.",
        )
        <fig-conic-gradient>
    ],
    kind: image,
    caption: tauthesis.figureCaption(
        ...
        long: [
            ...
            radial gradient in @fig-radial-gradient and the
            conic gradient in @fig-conic-gradient.
        ],
    ),
