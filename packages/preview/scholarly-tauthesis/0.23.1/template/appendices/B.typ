...
#figure(
    ...
    caption: tauthesis.figureCaption(
        short: [
            This is a short version of the actual long
            image caption in the appendix.
        ],
        long: [
            A test image with a very long caption:
            #lorem(26) The caption will be shorter in the
            list of figures.
        ],
    )
    ,
...
the radial gradient in @fig-radial-gradient and
the tilted sparsely sampled linear gradient in
@fig-tilted-sampled-linear-gradient.
