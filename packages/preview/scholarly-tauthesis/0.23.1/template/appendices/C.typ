...
// This chapter title is very long so it would not fit into the page header.
// We use this function to provide a long and short body for the heading.

#tauthesis.contextualHeading(
  long: [
  ...
  short: [Long heading tests with math and code],
)
