...
Tampere University. Versions
#math.equation(
  alt: "greater than or equal to",
  $>=$
)
#version(0,15,0) of the Typst compiler required by this
template have the capability of creating PDF/UA-1- and
PDF/A-3a-compliant PDF documents simultaneously:
```sh
typst compile --pdf-standard ua-1,a-3a template/main.typ
```
The need for this _accessible_ archival standard
combination comes from standard-compliant files containing
accessibility tags, that screen readers utilized by
visually impaired people can use to read your thesis. These
tags can be viewed with utilities such as the Lua program
...
You should make sure that your thesis actually conforms to
the PDF/UA-1 and PDF/A-3a standards, before submitting it
to Tampere University archive
...
at https://muuntaja.tuni.fi _cannot_ automatically generate
