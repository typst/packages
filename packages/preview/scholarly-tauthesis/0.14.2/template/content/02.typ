...
limitations, one should at least try to describe what is happening in each
image or table in the body text as well as they can. The Typst function `image`
accepts the named argument `alt`, which allows you to provide an alternative
text for an included image~@typst-image-function.
