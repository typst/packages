...
#let template(
	...
	show heading: it => headingShowRule(language, mathFont, figNumberWithinLevel, eqNumberWithinLevel, it)
	...
	show outline.entry: it => outlineEntryShowRule(language, figNumberWithinLevel, thesisTypeNum, mathFont, it)
