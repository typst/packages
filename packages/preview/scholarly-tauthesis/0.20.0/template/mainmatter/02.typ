...
#figure(
    ...
    kind: image,
    caption: [
        A display of a few different color gradient shapes
        available in Typst. These include the linear
        gradient in @fig-linear-gradient, the radial
        gradient in @fig-radial-gradient and the conic
