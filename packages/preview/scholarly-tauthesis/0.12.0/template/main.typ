...
#import "@preview/scholarly-tauthesis:0.12.0" as tauthesis
...
#let työnTyyppi = tauthesis.diplomiTyönTyyppi
...
#let thesisType = tauthesis.mastersThesisType
#let title = "Thesis template"
#let university = "Tampere University"

// Set the heading levels under which figures and equations are numbered.
