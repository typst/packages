...
regarding this. Practically this means compiling the final
PDF into a combined PDF/UA-1 and PDF/A-3a format:
```sh
typst compile --pdf-standard ua-1,a-3a template/main.typ
```
Use veraPDF~@verapdf, showtags~@texlive-showtags,
PAC~@axes4-pac-software (if you have access
to Windows#sym.trademark.registered) or some
other software listed by the PDF Association
