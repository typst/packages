...
//       [#eg-num-label()<eg-syn1>], [#subex-label()<eg-a>], [sentence a],
//       [],                         [#subex-label()<eg-b>], [sentence b],
//     )
//   ]
...
//       stroke: none,
//       align: (left + bottom, left + bottom, left + top),
//       [#eg-num-label()<eg-1>], [#subex-label()<eg-1a>], [sentence a],
//       [],                      [#subex-label()<eg-1b>], [sentence b],
//     )
//   ]
#let eg-num-label() = {
