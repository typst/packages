...
点击链接: https://typst.app/app?template=golixp-resume-zh-cn&version=0.1.2
...
git clone https://github.com/golixp/typst-resume-zh-cn.git ~/.local/share/typst/packages/local/golixp-resume-zh-cn/0.1.2
```
...
git clone https://github.com/golixp/typst-resume-zh-cn.git ~/Library/Application\ Support/typst/packages/local/golixp-resume-zh-cn/0.1.2
```

Windows:

```powershell
mkdir -Force "$env:APPDATA\typst\packages\local\golixp-resume-zh-cn\0.1.2"
git clone https://github.com/golixp/typst-resume-zh-cn.git "$env:APPDATA\typst\packages\local\golixp-resume-zh-cn\0.1.2"
```
...
```typst
// 本地包导入
#import "@local/golixp-resume-zh-cn:0.1.2": *
```
...
Click the link: https://typst.app/app?template=golixp-resume-zh-cn&version=0.1.2
