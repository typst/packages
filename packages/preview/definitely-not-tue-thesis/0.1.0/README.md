...
> This is an unofficial, community-built template. It is not affiliated with,
> maintained by, or endorsed by Eindhoven University of Technology. Check your
> department's own requirements before submitting.

## Getting started

```sh
typst init @preview/definitely-not-tue-thesis:0.1.0
cd definitely-not-tue-thesis
...
```typst
#import "@preview/definitely-not-tue-thesis:0.1.0": thesis
