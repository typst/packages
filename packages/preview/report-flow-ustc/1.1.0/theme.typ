...
#let project(
  ...
  show raw: set text(font: code_font, size: code_size)
  set page("a4",
  ...
  text(watermark_size, fill: rgb("#034ea10f"), font:watermark_font)[
      #strong()[#watermark]
    ]
  ),
  )
  ...
  header: [
    #set text(8pt)
    #course -- #lab_name
    #h(1fr) #text(font:watermark_font,fill:secondary)[#watermark]
  ],
  // number-align: right,
  // numbering: "壹 / 壹",
)
