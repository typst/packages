...
<div align="center">Version 3.0.2</div>
...
```typ
#import "@preview/letterloom:3.0.2": *
...
```bash
typst init @preview/letterloom:3.0.2
```

This will generate a ready-to-use letter project in your current directory.

Alternatively, you may create a new project directly in the [Typst webapp](https://typst.app/app?template=letterloom&version=3.0.2).
