...
== Exemplo de seção de apêndice não apresentada no sumário

#lorem(30)

=== Exemplo de subseção de apêndice não apresentada no sumário
...
== Definições relacionadas a elementos pré-textuais
...
== Definições relacionadas a elementos textuais
...
== Definições relacionadas a elementos pós-textuais
...
=== Referências bibliográficas e citações às referências bibliográficas
