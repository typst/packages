...
#quote(
  [Privacy matters; privacy is what allows us to determine who we are and who we
    ...
    therefore no room for intellectual exploration and creativity.], [Edward Snowden],
)
#v(1em)

#lorem(25)
#todo(
  [ Describe the kind of problem at hand? The problem is relevant in which context?
    What does not work well at the moment? What do people need? Describe the
    background, the prerequisites for your work. Optionally, add terms and
    definitions whenever they might not be clear to a fellow student. ],
)
...
#lorem(25)
#todo(
  [ What is the overall problem? Give examples. Motivate! Compared to existing
    solutions for the problem at hand, why does someone need a better, faster, and
...
#todo(
  ...
  *Hints for footnotes in Typst*:
  ...
  As shown in #footnote[Visit https://typst.app/docs for more details on formatting the document using
    typst. Note, _typst_ is written in the *Rust* programming language.] we migth
