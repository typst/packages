...
<img src="docs/readme-banner.svg" alt="a collection of Tabler.io icons in the background in a grid pattern and in the middle of the image is the title of the package with version number.">
