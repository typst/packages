#import "@preview/tableau-icons:0.340.0" as tableau-icons
#import "thumbnail_list.typ": *

#import "@preview/tidy:0.4.3"
#import "@preview/shadowed:0.3.0": shadowed
...
#show heading.where(level: 3): it => {
  grid(
    ...
    align: horizon,
    column-gutter: 3pt,
    box(align(horizon+center,tableau-icons.ti-icon("code", fill: blue, size: 1em)), width: 1.1em, height: 1.1em, stroke: blue + 0.5pt, radius: 2pt),
    grid.cell(
      it.body,
