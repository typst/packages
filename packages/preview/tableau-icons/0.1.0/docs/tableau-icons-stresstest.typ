...
#box(clip: true, width: 100%, height: 8cm)[
  #box(
    ...
    rotate(
      -10deg,
      [
        #for icon in icons_filled.slice(0, 303) {
          (
...
#for icon in icons_filled {
  (
    tbl.inline-filled(icon, fill: color.lighten(orange, 10%), width: 1em, baseline: 20%)
  )
}
...
#for icon in icons_outlined {
  (
    tbl.inline-outlined(icon, fill: color.lighten(red, 10%), width: 1em, baseline: 20%)
  )
}
