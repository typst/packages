...
# 上海交通大学博士研究生学位论文年度进展报告

# SJTU Doctoral Annual Progress Report

**Typst Template**

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Typst Package](https://img.shields.io/badge/Typst-Package-239DAD)](https://typst.app/universe/package/std-sjtu-doctoral-annual-progress)

本模板严格依据上海交通大学研究生院官方 [Word 模板](https://www.gs.sjtu.edu.cn/xzzx/pygl) 制作  
相比传统 LaTeX，Typst 提供 **毫秒级编译速度** 与 **零配置环境**

📖 [查看完整文档](#-使用指南) | 🎯 [快速开始](#-快速开始) | 💬 [问题反馈](https://github.com/zh1-z/SJTU-Doctoral-Annual-Progress-Typst-Template/issues)

---

### ✨ 如果这个模板对你有帮助，请[点个 Star ⭐](https://github.com/zh1-z/SJTU-Doctoral-Annual-Progress-Typst-Template) 支持一下！
...
3. 搜索框输入 `std-sjtu-doctoral-annual-progress`
...
3. 在模板库中搜索 `std-sjtu-doctoral-annual-progress`
4. 选择模板并指定项目路径，自动创建项目

**选项 B：克隆仓库（灵活）**

```bash
git clone https://github.com/zh1-z/SJTU-Doctoral-Annual-Progress-Typst-Template.git
cd SJTU-Doctoral-Annual-Progress-Typst-Template/0.1.0
```
...
#show: body => project(
  // --- 封面信息 ---
  student-id:     "012345678901",        // 12位学号
  name:           "你的名字",
  supervisor:     "你的导师",
  major:          "你的专业",
  school:         "你的学院",
  enrollment:     "b",                    // a/b/c (见说明)
  degree-program: "a",                    // a/p (见说明)
  date:           today-date,             // 或自定义 "2026-01-01"

  // --- 正文开头的特制表格 ---
  dissertation-title: "你的论文题目",     // 支持使用 \n 手动换行
  source-of-research-project: (1, 3),     // 研究课题来源（可多选）
  dissertation-proposal-date: "2026-01-01", // 开题报告日期
...
A: 本模板严格按照官方最新版制作，但如发现格式问题，欢迎提交 [Issue](https://github.com/zh1-z/SJTU-Doctoral-Annual-Progress-Typst-Template/issues) 反馈。
</details>
...
- ⭐ 给项目[点个 Star](https://github.com/zh1-z/SJTU-Doctoral-Annual-Progress-Typst-Template)
- 🐛 提交 Bug 报告和功能建议
- 🔀 Fork 并改进模板
- 📢 分享给更多需要的同学
