...
While LaTeX has been the de facto standard for academic typesetting for decades, its steep learning curve and cryptic error messages can be cumbersome. This Typst template targets thesis documents at the Faculty of Engineering, University of Freiburg while offering a more approachable writing experience.
