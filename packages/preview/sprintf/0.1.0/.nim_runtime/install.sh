...
if [ $# -eq 1 ] ; then
  ...
  case $1 in
    ...
    "/usr/bin")
      ...
      nimbleDir="/opt/nimble/pkgs/nim-2.2.8"
      ;;
    "/usr/local/bin")
      bindir=$1
      configdir="/etc/nim"
  ...
  cp "lib/system/sysmem.nim" "$libdir/system/sysmem.nim"
  chmod 644 "$libdir/system/sysmem.nim"
  ...
  cp "compiler/astdef.nim" "$nimbleDir/compiler/astdef.nim"
  chmod 644 "$nimbleDir/compiler/astdef.nim"
  ...
  cp "compiler/deps.nim" "$nimbleDir/compiler/deps.nim"
  chmod 644 "$nimbleDir/compiler/deps.nim"
