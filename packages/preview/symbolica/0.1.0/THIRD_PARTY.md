...
LGPLv3 Section 4 also requires that the combined work's terms not restrict
reverse engineering for debugging modifications to the LGPL-covered portions.
The Symbolica Typst permission leaves Symbolica's existing restrictions
unchanged. Their compatibility with this requirement remains unresolved;
source availability alone does not resolve it.
