...
#let args = arguments(
  ...
  edge(1, 3, bezier: ((2, 1), (3, 0.8)), style: (stroke: (paint: red))),
  edge(2, 3, bezier-rel: ((0, 0.2), (0, -0.2))),
  edge(1, 4, bezier: ((3, 0.5),), style: (stroke: (paint: green))),
  edge(3, 4, bezier-rel: ((-0.5, -0.5),), style: (stroke: (paint: green))),
  edge(3, 5, bezier-rel: ((-0.5, 0.5),)),
  edge(5, 5, bezier: ((1, 4.5), (3, 4.5)), style: (stroke: (dash: "dashed", paint: rgb("#b39a29")))),
)
