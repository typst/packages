...
#let code-file(title: "", file-content: "", lang, fill, line-numbers: true, line-number-color: gray) = {
  frame(
    title: title,
    fill: fill,
...
#let code-snippet(title: "", file-content: "", subtitle: none, lang, fill, line-numbers: true, line-number-color: gray, from: 0, to: int) = {
