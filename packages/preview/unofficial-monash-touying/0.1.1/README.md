...
```sh
typst init @preview/unofficial-monash-touying:0.1.1 my-slides
```
...
#import "@preview/unofficial-monash-touying:0.1.1": *
...
package import such as `@preview/unofficial-monash-touying:0.1.1` rather than a
