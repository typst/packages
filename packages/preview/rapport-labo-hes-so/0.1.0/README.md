...
|       └── assets/
|            ├── picture/                ← Vos images et logo
|            ├── code/                   ← Fichiers code à importer
|            └── PDF/                    ← Annexes PDF
│
├──layout/
│       ├── 1_layout.typ        ← Mise en page
│       ├── 2_layout.typ        ← Contenu final
│       ├── cover_page_layout.typ
│       ├── signature.typ
│       └── box_layout.typ      ← Boîtes utilitaires
└── docs/                       ← Documentation
```
...
### Boîtes utilitaires
```typst
#info_box[Votre texte d'information]
#danger_box[Attention !]
#valid_box[✅ Succès]
#feu_box[🔥 Erreur]
#idea_box[💡 Idée]
#todo_box[- Tâche 1\n- Tâche 2]
