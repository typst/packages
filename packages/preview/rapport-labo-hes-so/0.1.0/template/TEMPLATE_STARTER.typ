...
== Boîte d'information
#info_box[Ceci est une boîte d'information. Elle contient des détails importants et des conseils pratiques.]

== Boîte d'attention
#danger_box[⚠️ Attention ! Cette zone contient un risque identifié. Respectez les consignes de sécurité.]

== Boîte de validation
#valid_box[✅ La validation des résultats a réussi avec une précision de 98%.]

== Boîte d'erreur
#feu_box[🔥 Erreur critique détectée dans le circuit à 14h30. Calibrer les instruments.]

== Boîte d'idée
#idea_box[💡 Suggestion : utiliser une meilleure source de signal pour améliorer la précision des mesures.]
...
#danger_box[Attention à  la qualité des images, si le fichiers est trop volumineux lorsque l'on va convertir le code Typst en PDF cela va créer un fichier PDF ultra lourd. Il est possible de passer après par #link("https://www.ilovepdf.com/fr/compresser_pdf", "I-love PDF") pour réduire la taille du fichier.]
...
#info_box[Les graphiques sont créés avec la librairie *lilaq*, qui offre une flexibilité maximale pour créer des courbes et des diagrammes scientifiques.]
