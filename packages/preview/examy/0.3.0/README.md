...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/quiz.png" width="45%" alt="A quiz with empty answer boxes">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/quiz-solutions.png" width="45%" alt="The same quiz compiled with solutions shown">
</p>
<p align="center"><em><a href="https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/quiz.typ">examples/quiz.typ</a>, compiled without and with solutions.</em></p>

See [examples/](https://github.com/siefkenj/typst-examy/tree/0.3.0/examples/) for usage examples.
...
From [examples/final-exam.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/final-exam.typ) (solutions
...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/question-page.png" width="60%" alt="A question with two parts and answer boxes">
</p>
...
[examples/numbering.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/numbering.typ):
...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/numbering.png" width="70%" alt="Questions numbered 1, 2, 10, 11, a star, an unnumbered one, and 12">
</p>
...
From [examples/points.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/points.typ):
...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/points.png" width="70%" alt="Questions with point badges, and a points table totalling 10">
</p>
...
Both renders of [examples/solutions.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/solutions.typ), which puts
one solution inside an answer box and one inline:

<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/solutions.png" width="45%" alt="Two questions with an empty answer box">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/solutions-key.png" width="45%" alt="The same questions with solutions shown in blue">
</p>
...
[examples/bundle.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/bundle.typ):
...
[examples/quiz.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/quiz.typ) uses this to add the answer curve of
...
in question 1. From
[examples/cross-references.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/cross-references.typ):
...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/cross-references.png" width="70%" alt="References rendering as (a) from a sibling part and 1 (a) from another question">
</p>
...
From [examples/name-blocks.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/name-blocks.typ):
...
<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/name-blocks.png" width="70%" alt="A default name block and a custom one with a name hint, an email suffix, and a verbatim row">
</p>
...
From [examples/final-exam.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/final-exam.typ) (name fields
...
See [examples/quiz.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/quiz.typ) for a minimal quiz,
[examples/final-exam.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/final-exam.typ) for a complete exam with
custom name fields, and
[examples/utoronto-exam.typ](https://github.com/siefkenj/typst-examy/blob/0.3.0/examples/utoronto-exam.typ) for the preset in
use.

<p align="center">
  <img src="https://raw.githubusercontent.com/siefkenj/typst-examy/0.3.0/examples/images/cover.png" width="60%" alt="An exam cover page with a points table">
</p>
...
All names below are exported by `#import "@preview/examy:0.3.0": *`.
