...
Check out [thesis.typ](https://github.com/wangjq4214/buaa-thesis/blob/0.3.0/template/thesis.typ) and [thesis.pdf](https://github.com/wangjq4214/buaa-thesis/blob/0.3.0/example/thesis.pdf) to see the specific code and generated PDF file.
