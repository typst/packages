  ...
  self = utils.merge-dicts(
    ...
    config-page(
      ...
      fill: self.colors.neutral-lightest,
       margin: (top: 80pt, bottom: 1.25em, x: 2em),
      ),
  )
...
#let pappso-presentation-theme(
  ...
  show: touying-slides.with(
    ...
    config-methods(
      init: (self: none, body) => {
        set text(font: font, fill: self.colors.neutral-darkest, size: 15pt)
    ...
    config-colors(
      primary: pappso-color,
      secondary: pappso-color.lighten(20%),
      tertiary: pappso-color.lighten(40%),
      neutral-lightest: rgb("#ffffff"),
      neutral-darkest: rgb("#000000"),
    ),
...
#let pappso-revue-presentation-theme(
  aspect-ratio: "16-9",
  progress-bar: true,
  font: "PT Sans",
  header: "",
