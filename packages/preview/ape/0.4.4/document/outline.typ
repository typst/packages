    ...
    grid(
      ...
      ..for e in query(heading) {
        if content-to-string(e) != "" {
          ...
          if (
            (e.location().position().page == here-page and e.location().position().y >= here-y)
              or (e.location().position().page > here-page)
          ) {
            if (
              e.location().position() in titles-positions
                or e.location().position() in sections-positions
                or e.location().position() in subsections-positions
            ) {
              break
            } else if e.depth == 1 {
              (
