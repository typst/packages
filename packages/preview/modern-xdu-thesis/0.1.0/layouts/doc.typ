...
// 版心下边界（P5 与真实论文对照后裁定，见 docs/与真实论文对照.md §4）
...
// 实现。P1 实测：若改用 v() 在段落流里排版，间距会变成 5.94pt 而非 1pt。
