...
**本模板不是学校官方发布**，版式数值以学校发布的 Word / LaTeX 模板及配套规范为准；与官方模板存在差异的地方
...
| 符号对照表字号 | 本模板按《撰写要求》采用 12pt；官方 LaTeX 示例未包含此页 |
| 附录页 | 官方示例未包含附录页，其坐标按其它后置部分的统一规则处理 |
...
报版式差异时请附上学校官方模板或规范的对应页，以便按同一依据复核。
