...
In the folder `examples` of the GitHub Repository [lvandevelde/typst-minerva-thesis](https://github.com/lvandevelde/typst-minerva-thesis/tree/v0.2.3) basic examples of a PhD and a master's thesis are given. 
...
The documentation on the functions of this package can be found in [`docs/Documentation.md`](https://github.com/lvandevelde/typst-minerva-thesis/blob/v0.2.3/docs/Documentation.md) 
