#let flag-v2(colors,height:.65em,ratio:3/5,color_width:(1/2,)*2) = {
  box(
    height:height,
...
#let flag-v3(colors,height:.65em,ratio:2/3,color_width:(1/3,)*3) = {
  box(
  height:height,
  width:1/ratio*height,
  outset: 0pt,
...
#let flag-h3(colors,height:.65em,ratio:3/5,color_height:(1/3,)*3) = {
  box(
  height:height,
  width:1/ratio*height,
  outset: 0pt,
...
#let flag-cross(colors,height:.65em,x_sets:(5,0,3,0,10),y_sets:(4,0,3,0,4), full_cross:true) = {
...
#let flag-am(height:.65em) = {
  flag-h3((rgb(217,0,18),rgb(0,51,160),rgb(242,168,0)), height: height, color_height: (1/3,1/3,1/3), ratio: 1/2)
}
// ao 2:3
...
#let flag-bs(height:.65em) = {
  box(
    flag-h3((rgb(0,119,139),rgb(255,199,44), rgb(0,119,139)),height: height, ratio:1/2, color_height: (1/3,1/3,1/3))
    + place(
      dy:-height,
      polygon(
        (0%*height,0%*height),
...
#let flag-by(height:.65em) = {
  box(
    flag-h3((rgb(0,151,57),rgb(210,39,48), none),height: height, ratio:1/2, color_height: (2/3,1/3,0))
    + place(
      dy:-height,
...
#let flag-bz(height:.65em) = {
  box(
    flag-h3((rgb("d90f19"),rgb("171696"),rgb("d90f19")), height: height,ratio:3/5,color_height: (1/10,8/10,1/10))
    + place(
        dy:-5/6*height,
...
#let flag-ca(height:.65em) = {
  box(
    flag-v3((rgb("ed1c24"),white,rgb("ed1c24")), height:height, color_width: (1/4,1/2,1/4), ratio: 1/2)
    + place(
      dx:(1/2+1/7)*height,
      dy:(-1+1/8)*height,
...
#let flag-ch(height:.65em) = {
  flag-cross((rgb(200,16,46),rgb(200,16,46),white), height:height,x_sets: (1,1,1,1,1),y_sets: (1,1,1,1,1), full_cross: false)
}
// ci 2:3
...
#let flag-cl(height:.65em) = {
  box(
    flag-h3((white,rgb(213,43,30),none),color_height: (1/2,1/2,0),ratio:2/3, height: height)
    + place(
      dy:-height,
      rect(
        fill:rgb(0,57,166),
...
#let flag-co(height:.65em) = {
  box(
    flag-h3((rgb("FFCD00"),rgb("003087"),rgb("C8102E")),color_height: (1/2,1/4,1/4), height: height, ratio:2/3)
  )
}
// cr 3:5
...
#let flag-cz(height:.65em) = {
  box(
    flag-h3((white,cmyk(0%, 100%, 96%, 8%),none),height: height,color_height: (1/2,1/2,0), ratio:2/3)+
    place(
      dx: 0pt,
      dy:-height,
      polygon(
...
#let flag-dk(height:.65em) = {
  flag-cross((rgb(200,16,46),none,white),height: height, x_sets: (12,0,4,0,21),y_sets: (12,0,4,0,12)) 
}
// dz 2:3
...
#let flag-ec(height:.65em) = {
  box(
    flag-h3((rgb("FFDD00"),rgb("034ea2"),rgb("ed1c24")),color_height: (1/2,1/4,1/4), height: height, ratio:2/3)
    +place(
      dy:-3/4*height,
      dx:2/4*height,
...
#let flag-es(height:.65em) = {
  box(
    flag-h3((rgb("AD1519"),rgb("FABD00"),rgb("AD1519")), height:height,color_height: (1/4,1/2,1/4),ratio:2/3)+place(
      // coat of arms
      dx:height*30%,
      dy:height*-72%,
...
#let flag-fi(height:.65em) = {
  flag-cross((white,none,blue), height: height, x_sets: (5,0,3,0,10), y_sets: (4,0,3,0,4) )
}
// fr 2:3
...
#let flag-ge(height:65em) = {
  box(
    flag-cross((white,none,red),height:height, x_sets: (130,0,40,0,130), y_sets: (80,0,40,0,80))
...
#let flag-gr(height:.65em) = {
  ...
  stack(
    dir:ttb,
    flag-h3((rgb("004C98"),white,rgb("004C98")),height: height/3,color_height: (1/3,1/3,1/3), ratio:2/9),
    flag-h3((white,rgb("004C98"),white),height: height/3,color_height: (1/3,1/3,1/3), ratio:2/9),
    flag-h3((rgb("004C98"),white,rgb("004C98")),height: height/3,color_height: (1/3,1/3,1/3), ratio:2/9),
  )+place(
      dy:-height,
      flag-cross((rgb("004C98"),rgb("004C98"),white),height: height*10/18, x_sets: (1,1,1,1,1),y_sets: (1,1,1,1,1),)
    )
  )
}
// gt 5:8
...
#let flag-ht(height:.65em) = {
  box(
    flag-h3((rgb("00209f"),rgb("d21034"),none),color_height: (1/2,1/2,0), height: height, ratio:3/5)
    +place(
      dy:-3/4*height,
      dx:5/3/3.2*height,
...
#let flag-is(height:.65em) = {
  flag-cross((rgb("02529C"),rgb("FFFFFF"),rgb("DC1E35")),height: height,x_sets: (7,1,2,1,14),y_sets: (7,1,2,1,7))
}
// it 2:3
...
#let flag-li(height:.65em) = {
  box(
    flag-h3((rgb(0,39,128),rgb(207,9,33),none),height: height,ratio:3/5,color_height: (1/2,1/2,0))+place(
      // coat of arms
      dx:height*40%,
      dy:height*-92%,
...
#let flag-lv(height:.65em) = {
  flag-h3((rgb(158, 27, 52),rgb("FFFFFF"),rgb(158, 27, 52)),height: height,ratio:1/2,color_height:(2/5,1/5,2/5))
}
// ly 1:2?
...
#let flag-mc(height:.65em) = {
  flag-h3((rgb("CF142B"),rgb("FFFFFF"),none), color_height: (1/2,1/2,0), height:height)
}
// md 1:2
#let flag-md(height:.65em)={
  box(
    flag-v3((rgb("0046ae"),rgb("ffd200"),rgb("cc092f")),height: height, ratio:1/2, color_width: (1/3,1/3,1/3))
...
#let flag-no(height:.65em) = {
  flag-cross((rgb("BA0C2F"),rgb("FFFFFF"),rgb("00205B")),height: height,x_sets: (6,1,2,1,12),y_sets: (6,1,2,1,6))
}
// np 4/3:1
...
#let flag-pl(height:.65em) = {
  flag-h3((rgb("EEEEEE"),rgb("D4213D"),none),height: height, ratio:5/8,color_height: (1/2,1/2,0))
}
// ps 1:2
...
#let flag-pt(height:.65em) = {
  box(flag-v2((rgb("006600"),rgb("FF0000")),height: height, ratio:2/3, color_width: (2/5,3/5))+place(
    // coat of arms
    dx:(2/5)*height,
    dy:-2/3*height,
...
#let flag-ro(height:.65em) = {
  flag-v3((rgb("002b7f"),rgb("fcd116"),rgb("ce1126")),height: height, ratio:2/3, color_width: (1/3,1/3,1/3))
}
// rs 2:3
...
#let flag-se(height:.65em) = {
  flag-cross((rgb("005293"),none,rgb("FFCD00")),height: height,x_sets: (5,0,2,0,9),y_sets: (4,0,2,0,4))
}
// sg 
...
#let flag-sm(height:.65em) = {
  box(
    flag-h3((white,cmyk(55%,10%,5%,0%),none),height: height,ratio: 3/4,color_height: (1/2,1/2,0))
    + place(
        dy:-(1-5/18)*height,
        dx:1/2*height,
...
#let flag-ua(height:.65em) = {
  flag-h3((rgb("0057b8"),rgb("ffd700"),none), height: height, color_height: (1/2,1/2,0), ratio: 2/3)
}
// ug 2:3
...
#let flag-va(height:.65em) = {
  box(
    flag-v2((rgb(255,242,0),white),height: height, ratio:1, color_width: (1/2,1/2))
    +place(
      // coat of arms
      dx:(13/22)*height,
      dy:-16/22*height,
