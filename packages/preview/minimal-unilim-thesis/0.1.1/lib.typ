    ...
    footer: context [
      #align(left)[
        #text(
          ...
          [#data.at(9).author | Mémoire de #data.at(5).degree | Université de Limoges #h(1fr)#counter(page).display() ]
        }else{
          [#data.at(9).author | #data.at(5).degree thesis | University of Limoges #h(1fr)#counter(page).display() ]
        }]
