...
2. [Create a project using the template](https://typst.app/app?template=modern-zhaw-thesis&version=0.3.0)
...
4. Run `typst init @preview/modern-zhaw-thesis:0.3.0` in your project directory
