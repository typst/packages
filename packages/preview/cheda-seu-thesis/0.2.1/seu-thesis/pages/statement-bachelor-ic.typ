...
#page(paper: "a4", margin: (top: 2cm+0.5cm, bottom: 2cm+0.5cm, left: 2cm+0.25cm, right: 2cm+0.25cm), {
  v(80pt-0.4cm)
  set align(left)
  ...
  align(center, text(font: 字体.黑体, size: 字号.小二)[东南大学毕业（设计）论文独创性声明])
  v(24pt)
  h(2em)
  ...
  align(center, text(font: 字体.黑体, size: 字号.小二)[东南大学毕业（设计）论文使用授权声明])
  v(13pt)
  h(2em)
