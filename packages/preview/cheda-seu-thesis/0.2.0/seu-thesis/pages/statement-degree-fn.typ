...
#let degree-statement-conf(
  anonymous: false,
) = page(header: none, footer: none, numbering: none, margin: 2.5cm, {
  ...
  block({
    align(
      center, 
      text(font: 字体.黑体, size: 15pt, tracking: 0.3em)[东南大学学位论文独创性声明]
    )
    v(1.5em)
  ...
  本人声明所呈交的学位论文是我个人在导师指导下进行的研究工作及取得的研究成果。尽我所知，除了文中特别加以标注和致谢的地方外，论文中不包含其他人已经发表或撰写过的研究成果，也不包含为获得东南大学或其它教育机构的学位或证书而使用过的材料。与我一同工作的同志对本研究所做的任何贡献均已在论文中作了明确的说明并表示了谢意。
    ...
    align(
      center, 
      text(font: 字体.黑体, size: 15pt, tracking: 0.3em)[东南大学学位论文使用授权声明]
    )
