...
A full manual is available in [docs/manual.pdf](https://github.com/nathan-ed/typst-package-simple-plot/blob/d7e68370a7aa3e252de3e1d7aa4a01c44fd79e16/docs/manual.pdf).
