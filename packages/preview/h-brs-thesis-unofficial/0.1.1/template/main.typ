...
#cite(<kees2019>, form: "prose") untersuchen wissenschaftliche Arbeitsmethoden im Informatik-Bereich und stellen fest, dass eine strukturierte Vorgehensweise maßgeblich zur Qualität der Ergebnisse beiträgt. Diese Erkenntnisse fließen in die Methodik der vorliegenden Arbeit ein.

= Methodik und Anwendung

== Vorgehensweise

Auf Basis der im vorangegangenen Kapitel erarbeiteten Grundlagen wird in diesem Abschnitt ein Lösungsansatz entwickelt. Die Auswahl der eingesetzten Methoden orientiert sich an den Kriterien Skalierbarkeit und Wartbarkeit. Der zugrunde liegende Ablauf ist in @fig-workflow dargestellt.
...
#figure(
  table(
    ...
    table.header(
      [*Verfahren*], [*Laufzeit (ms)*], [*Genauigkeit (%)*], [*Speicherbedarf (in Megabyte)*],
    ),
    [Baseline],              [142], [87.3], [512],
    [Ansatz 1],              [105], [88.1], [480],
    [Ansatz 2 (vorgeschlagen)], [93],  [88.7], [460],
  ),
