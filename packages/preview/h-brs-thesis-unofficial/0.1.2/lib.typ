...
#let print-list-of-figures-page = print-list-of-figures
#let print-abbreviations-page = print-abbreviations
...
#let template(
  ...
  if print-list-of-figures {
    print-list-of-figures-page(strings)
  }
  ...
  if abbr-csv-content != none {
    if print-abbreviations {
      print-abbreviations-page(strings)
    }
  }
  pagebreak()
