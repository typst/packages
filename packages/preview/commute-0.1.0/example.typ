...
(plz don't report me to the math police, i know that the arrows are wrong, it's just to show all the different versions)
#align(center)[#commutative_diagram(
...
#align(center)[#commutative_diagram(debug: true,
  node((0, 0), [$A$]),
  node((0, 1), [$B$]),
  node((0, 2), [$C$]),
  node((0, 3), [$D$]),
