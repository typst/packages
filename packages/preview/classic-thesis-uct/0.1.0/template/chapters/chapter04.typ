...
#image_figure("4.1", [Example methodology figure. Replace this with a workflow, architecture, pipeline, sampling design, or study process diagram.])[
...
#numbered_equation("4.1", $ J(theta) = sum_(i = 1)^n w_i (y_i - hat(y)_i(theta))^2 $)
