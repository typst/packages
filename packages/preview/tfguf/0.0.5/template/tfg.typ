...
#figure(
  [Contenido figura],
  caption: caption[Un afigura sencilla con un elemento math llamado $ket(psi) = cos(theta\/2) ket(0) + e^(i phi) sin(theta\/2) ket(1)$ ][La he hecho yooo],
)
...
#figure(kind: image, mi-diagrama, caption: [Hola esto es una figura $1/2$ x.])
...
= Conclusiones
Unas conclusiones que concuerdan con @typst-bibliography.
