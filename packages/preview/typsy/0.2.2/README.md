...
```typst
#import "@preview/typsy:0.2.2": class, Int
...
```typst
#import "@preview/typsy:0.2.2": Array, Int, matches
...
```typst
#import "@preview/typsy:0.2.2": Arguments, Int, Str, case, match, matches
...
```typst
#import "@preview/typsy:0.2.2": case, class, enumeration, match, Int
...
```typst
#import "@preview/typsy:0.2.2": safe-counter
...
```typst
#import "@preview/typsy:0.2.2": safe-state
...
```typst
#import "@preview/typsy:0.2.2": tree-counter
...
```typst
#import "@preview/typsy:0.2.2": fmt, panic-fmt
...
```typst
#import "@preview/typsy:0.2.2": Arguments, typecheck
...
```typst
#import "@preview/typsy:0.2.2": namespace
