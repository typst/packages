...
```typst
#import "@preview/typsy:0.2.5": class, Int
...
```typst
#import "@preview/typsy:0.2.5": Array, Int, matches
...
```typst
#import "@preview/typsy:0.2.5": Arguments, Int, Str, case, match, matches
...
```typst
#import "@preview/typsy:0.2.5": case, class, enumeration, match, Int
...
```typst
#import "@preview/typsy:0.2.5": safe-counter
...
```typst
#import "@preview/typsy:0.2.5": safe-state
...
```typst
#import "@preview/typsy:0.2.5": tree-counter
...
```typst
#import "@preview/typsy:0.2.5": fmt, panic-fmt
...
```typst
#import "@preview/typsy:0.2.5": namespace
