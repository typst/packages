...
```typst
#import "@preview/typsy:0.2.3": class, Int
...
```typst
#import "@preview/typsy:0.2.3": Array, Int, matches
...
```typst
#import "@preview/typsy:0.2.3": Arguments, Int, Str, case, match, matches
...
```typst
#import "@preview/typsy:0.2.3": case, class, enumeration, match, Int
...
```typst
#import "@preview/typsy:0.2.3": safe-counter
...
```typst
#import "@preview/typsy:0.2.3": safe-state
...
```typst
#import "@preview/typsy:0.2.3": tree-counter
...
```typst
#import "@preview/typsy:0.2.3": fmt, panic-fmt
...
```typst
#import "@preview/typsy:0.2.3": Arguments, typecheck
...
```typst
#import "@preview/typsy:0.2.3": namespace
