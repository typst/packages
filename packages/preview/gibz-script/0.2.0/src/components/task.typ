  ...
  context {
    ...
    base-box(
      [
        // Header
        #block(below: 6pt, [
          #text(font: heading-font, size: 0.75em, weight: 600, fill: theme.accent)[✏️ #t("exercise", lang: L)]
        ])
        #v(6pt)

        // Title
        #block(below: 6pt, [ #text(font: heading-font, size: 1.15em, weight: 700)[#title] ])
