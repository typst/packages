  ...
  lv: (
    ...
    documentary: (
      page: (
        ...
        declaration_layout: (
          title: "Apliecinājums",
          statement_prefix: "Es apliecinu, ka",
          thesis_label: (
            bachelor: "bakalaura darbs",
            master: "maģistra darbs",
            course: "kursa darbs",
          ...
          statement_suffix: "ir izstrādāts patstāvīgi Latvijas Universitātē Eksakto zinātņu un tehnoloģiju fakultātes Datorikas nodaļā, izmantojot tikai darbā norādītos informācijas avotus, un tas ir mans oriģināldarbs.",
          submission_statement: "Iesniedzot šo darbu Latvijas Universitātes informācijas sistēmās, autentificējoties ar saviem piekļuves datiem, apliecinu savu identitāti un to, ka iesniegtā darba elektroniskā versija ir galīgā un autentiskā darba versija.",
        ),
      ),
    ),
  ),
  en: (
    ...
    documentary: (
      page: (
        ...
        declaration_layout: (
          title: "Declaration",
          statement_prefix: "I confirm that the",
          thesis_label: (
            bachelor: "bachelor's thesis",
            master: "master's thesis",
            course: "course paper",
          ...
          statement_suffix: "was developed independently at the Faculty of Exact Sciences and Technology, Department of Computer Science, University of Latvia, using only the information sources cited in the thesis, and that it is my original work.",
          submission_statement: "By submitting this thesis in the University of Latvia information systems and authenticating with my access credentials, I confirm my identity and that the submitted electronic version of the thesis is the final and authentic version.",
        ),
      ),
    ),
  ),
