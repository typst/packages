...
#let acmart(
  ...
  let show_(body) = {
    ...
    show list: set block(above: list-spacing, below: list-spacing)
    show enum: set block(above: list-spacing, below: list-spacing)
    show terms: set block(above: list-spacing, below: list-spacing)
    ...
    show raw.where(block:true): set block(above: 0.6em, below: 0.6em)
