...
- 2025/06: improve the spacing of headings,
  in particular when a subsection follows a section
  (Gabriel Scherer)

- 2025/06: implement the 'review' option
  (Gabriel Scherer)

- 2025/06: all of the sample-acmsmall.tex file
  is now ported in tests/sample-acmsmall.typ
  (Gabriel Scherer)

- 2025/06: provide an 'appendix' function
  (Gabriel Scherer)

- 2025/06: provide an 'acknowledgments' function
  (Gabriel Scherer)

- 2025/06: improve the support for figures
  (Gabriel Scherer)

- 2025/06: better support for the ACM-recommended table style
  (Gabriel Scherer)
