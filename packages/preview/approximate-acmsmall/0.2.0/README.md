...
See [example.typ](template/example.typ) for a minimal example of using this template. You can copy and extend it to start a new document. To compile it:
...
In the development repository for this template you can find [sample-acmsmall.typ](https://codeberg.org/gasche/approximate-acmsmall-typst-template/src/branch/trunk/sample-acmsmall/sample-acmsmall.typ.typ), a port of the [sample file](https://github.com/borisveytsman/acmart/blob/primary/samples/samples.dtx) of the [acmart](https://github.com/borisveytsman/acmart) LaTeX package. It can serve as a larger example of how to adapt typical LaTeX idioms in Typst code designed to work well with the approximate-acmsmall package.
