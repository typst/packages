...
// When using these localized headings, the PDF export will have an empty
// outline: https://github.com/typst/typst/issues/3424. Replace the headings
// by the actual text to prevent this issue - hopefully it gets fixed soon.
= #ugent.i18n.Preface
