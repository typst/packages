/// Usage:
/// `#import "@preview/sos-ugent-style:0.3.0" as ugent`
...
#import "src/ugent-poster.typ" as poster: ugent-poster-template as poster-template
...
#import "src/styling/colors.typ" as colors


// Some submodules are lazy loaded
/// Usage (different ways, according to preference):
/// #import "@preview/sos-ugent-style:0.3.0" as ugent: utils.todo
