...
Install [Typst](https://typst.app/docs/) and create a new resume project:

```bash
typst init @preview/signal-resume:0.1.1 my-resume
cd my-resume
...
```typst
#import "@preview/signal-resume:0.1.1": resume
```
...
The fictional, feature-rich example at [`examples/generic`](examples/generic) is the canonical demonstration of the framework. It explores optional sections such as engineering highlights, certifications, languages, and community work without publishing anyone's personal resume. Replace its fictional details and claims with your own truthful evidence.

## Preview

[Download the fictional generic resume PDF](examples/generic/resume.pdf).

![Fictional generic resume example](docs/assets/generic-resume-page-1.png)
