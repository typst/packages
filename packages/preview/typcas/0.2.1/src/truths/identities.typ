...
#let identity-rules = (
  ...
  (
    id: "log1p-expm1",
    priority: 113,
    lhs: func("log1p", func("expm1", (type: "wild", name: "u"))),
    rhs: (type: "wild", name: "u"),
    label: "log1p(expm1(u)) = u",
    domain-sensitive: false,
  ),
  (
    id: "expm1-log1p",
    priority: 114,
    lhs: func("expm1", func("log1p", (type: "wild", name: "u"))),
    rhs: (type: "wild", name: "u"),
    label: "expm1(log1p(u)) = u",
    domain-sensitive: true,
  ),
  (
    id: "cbrt-cube",
    priority: 115,
    lhs: pow(func("cbrt", (type: "wild", name: "u")), num(3)),
    rhs: (type: "wild", name: "u"),
    label: "cbrt(u)^3 = u",
    domain-sensitive: false,
  ),
  (
    id: "sqrt-square-direct-rational",
    priority: 116,
    lhs: pow(pow((type: "wild", name: "u"), cdiv(num(1), num(2))), num(2)),
    rhs: (type: "wild", name: "u"),
    label: "(sqrt(u))^2 = u",
    domain-sensitive: true,
  ),
  (
    id: "sqrt-square-direct-float",
    priority: 117,
    lhs: pow(pow((type: "wild", name: "u"), num(0.5)), num(2)),
    rhs: (type: "wild", name: "u"),
    label: "(sqrt(u))^2 = u",
    domain-sensitive: true,
  ),
  (
    id: "min-idempotent",
    priority: 118,
    lhs: func("min", (type: "wild", name: "u"), (type: "wild", name: "u")),
    rhs: (type: "wild", name: "u"),
    label: "min(u,u) = u",
    domain-sensitive: false,
  ),
  (
    id: "max-idempotent",
    priority: 119,
    lhs: func("max", (type: "wild", name: "u"), (type: "wild", name: "u")),
    rhs: (type: "wild", name: "u"),
    label: "max(u,u) = u",
    domain-sensitive: false,
  ),
  (
    id: "clamp-degenerate",
    priority: 120,
    lhs: func("clamp", (type: "wild", name: "u"), (type: "wild", name: "a"), (type: "wild", name: "a")),
    rhs: (type: "wild", name: "a"),
    label: "clamp(u,a,a) = a",
    domain-sensitive: false,
  ),
  (
    id: "sign-abs",
    priority: 121,
    lhs: mul(func("sign", (type: "wild", name: "u")), func("abs", (type: "wild", name: "u"))),
    rhs: (type: "wild", name: "u"),
    label: "sign(u)|u| = u",
    domain-sensitive: false,
  ),
  (
    id: "abs-sign",
    priority: 121,
    lhs: mul(func("abs", (type: "wild", name: "u")), func("sign", (type: "wild", name: "u"))),
    rhs: (type: "wild", name: "u"),
    label: "|u|sign(u) = u",
    domain-sensitive: false,
  ),
  (
    id: "abs-over-self-sign",
    priority: 122,
    lhs: cdiv(func("abs", (type: "wild", name: "u")), (type: "wild", name: "u")),
    rhs: func("sign", (type: "wild", name: "u")),
    label: "|u|/u = sign(u)",
    domain-sensitive: true,
  ),
  (
    id: "self-over-abs-sign",
    priority: 123,
    lhs: cdiv((type: "wild", name: "u"), func("abs", (type: "wild", name: "u"))),
    rhs: func("sign", (type: "wild", name: "u")),
    label: "u/|u| = sign(u)",
    domain-sensitive: true,
  ),
