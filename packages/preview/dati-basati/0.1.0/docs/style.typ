...
#let show-parameter-block(
  ...
  [
    ...
    #if show-default [
      #parbreak()
      #utilities.get-local-name("default", style-args: style-args): #raw(lang: "typc", default)
    ]
  ],
)
...
#let show-function(
  ...
  block(breakable: style-args.break-param-descriptions, {
    heading(
      utilities.get-local-name("parameters", style-args: style-args),
