#import "proforma.typ": compute-hyperscore, get-ms2spectra-plot-from-proforma


#let psm-cbor-print-scan(
  scan,
) = [index=#scan.id.index mh=#calc.round(scan.precursor.mh, digits: 4) mz=#calc.round(scan.precursor.mz, digits: 4) charge=#scan.precursor.z rt=#calc.round(scan.ms2.rt, digits: 2)s]
