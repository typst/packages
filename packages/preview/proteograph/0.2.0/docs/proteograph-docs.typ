...
#show: project.with(
  title: "Proteograph",
  subtitle: "Typst proteomics package",
  authors: (
    "Olivier Langella",
  ),
  abstract: [
    *proteograph* is a package defining #link("https://typst.app/", [Typst]) functions dedicated to proteomics.
  ],
...
#pg-snippet("../examples/xic_plot.typ")


#{
  let module = tidy.parse-module(read("../src/xic_plot.typ"), name: "XIC plot full documentation")
...
The space between two peaks can be highlighted and manually annotated using an array
defined as follow

#code-block(read("ms2_peak_diff.json"), "json", title: "Highlight space between peaks array")
#pg-snippet("../examples/complete_psm_highlight_peaks.typ")
...
#pg-snippet("../examples/protein_sequence.typ")


#{
  let module = tidy.parse-module(read("../src/protein_sequence.typ"), name: "Protein sequence documentation")
  tidy.show-module(module, style: tidy.styles.default)
}
...
#{
  let module = tidy.parse-module(read("../src/protein_diag.typ"), name: "Protein diagram documentation")
  tidy.show-module(module, style: tidy.styles.default)
}
