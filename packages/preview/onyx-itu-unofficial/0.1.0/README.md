...
[![Typst Universe](https://img.shields.io/badge/typst-universe-239DAD)](https://typst.app/universe/package/onyx-itu-unofficial)

An unofficial [Typst](https://typst.app/) template for [IT University of Copenhagen](https://itu.dk/).

*Disclaimer: This template is NOT affiliated with the IT University of Copenhagen. The ITU logo included in this repository is the property of the IT University of Copenhagen and is provided for use by ITU students, staff, and researchers only. Use by others requires prior written approval: [ITU logo policy](https://itu.dk/Om-ITU/Presse/Logoer).*

<p align="center">
   <a href="main.pdf">
      <img src="docs/example-page-01.png" width="250" alt="Title page with ITU logo, centered title, authors, and advisers" />
      <img src="docs/example-page-09.png" width="250" alt="Interior page with chapter header, text, a small table, and footer with page number and ITU logo" />
      <img src="docs/example-page-13.png" width="250" alt="Bibliography page listing formatted references used in the document" />
   </a>
</p>
