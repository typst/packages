# Chinese Book Typst 模板使用说明

## 简介

`chinese-book` 是一个专为中文书籍排版设计的 Typst 模板，提供了符合中文排版规范的布局和样式。该模板支持各种书籍元素，包括封面、前言、目录、章节、附录等，并针对中文排版特点进行了优化。
...
```typst
#import "chinese-book.typ": chinese-book

#show: chinese-book.with(
  title: "我的书名",
  author: "作者名",
