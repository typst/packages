...
#let sonority-scale = (
  "a": 13, "ɑ": 13, "æ": 13, "ɐ": 13,
  "ɛ": 12, "ɔ": 12, "ʌ": 12, "œ": 12,
  "e": 12, "o": 12, "ə": 12, "ɘ": 12, "ɵ": 12, "ø": 12,
  "i": 12, "u": 12, "ɪ": 12, "ʊ": 12, "y": 12, "ɯ": 12, "ɨ": 12, "ʉ": 12,
  "j": 11, "w": 11, "ɥ": 11, "ɰ": 11,
  "ɾ": 10, "ɽ": 10,
  "l": 9, "ɫ": 9, "ʎ": 9, "ʟ": 9, "ɬ": 8, "ɮ": 8,
  "r": 8, "ʀ": 8, "ɹ": 8, "ʁ": 8, "ɻ": 8,
  "m": 7, "n": 7, "ŋ": 7, "ɲ": 7, "ɳ": 7, "ɴ": 7, "ɱ": 7,
  "v": 6, "z": 6, "ʒ": 6, "ð": 6, "ʐ": 6, "ʝ": 6, "ɣ": 6, "β": 6,
  "f": 3, "s": 3, "ʃ": 3, "θ": 3, "x": 3, "χ": 3, "ħ": 3, "h": 3, "ɸ": 3, "ç": 3, "ʂ": 3,
  "b": 4, "d": 4, "g": 4, "ɡ": 4, "ɢ": 4, "ɖ": 4, "ʄ": 4, "ɗ": 4, "ɓ": 4,
  "p": 1, "t": 1, "k": 1, "q": 1, "ʔ": 1, "ʈ": 1, "c": 1,
  "d͡ʒ": 5, "d͡z": 5, "d͡ʑ": 5, "ɖ͡ʐ": 5,
  "t͡ʃ": 2, "t͡s": 2, "t͡ɕ": 2, "ʈ͡ʂ": 2, "t͡θ": 2, "p͡f": 2,
)
  ...
  cetz.canvas(length: scale * 1cm, {
    ...
    if show-lines and n-phonemes > 1 {
      for i in range(n-phonemes - 1) {
        ...
        let y2 = float((sonority-values.at(i + 1) - y-range.at(0))) / float((y-range.at(1) - y-range.at(0))) * float(height)
