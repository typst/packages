...
#let fa-rectangle-hdr = fa-icon.with("\u{e773}")
...
#let fa-numpad = fa-icon.with("\u{e7cc}")
...
#let fa-mailbox-open-empty = fa-icon.with("\u{e821}")
#let fa-mailbox-open-letter = fa-icon.with("\u{e823}")
#let fa-lychee = fa-icon.with("\u{e824}")
#let fa-tank-recovery = fa-icon.with("\u{e825}")
#let fa-transducer = fa-icon.with("\u{e826}")
#let fa-box-arrow-up = fa-icon.with("\u{e827}")
#let fa-box-magnifying-glass = fa-icon.with("\u{e828}")
#let fa-envelope-certificate = fa-icon.with("\u{e829}")
#let fa-envelope-ribbon = fa-icon.with("\u{e829}")
#let fa-water-temp = fa-icon.with("\u{e82a}")
#let fa-water-temperature = fa-icon.with("\u{e82a}")
#let fa-aeropress = fa-icon.with("\u{e82b}")
#let fa-caret-large-down = fa-icon.with("\u{e82c}")
#let fa-caret-large-left = fa-icon.with("\u{e82d}")
#let fa-caret-large-right = fa-icon.with("\u{e82e}")
#let fa-caret-large-up = fa-icon.with("\u{e82f}")
#let fa-chemex = fa-icon.with("\u{e830}")
#let fa-hand-shaka = fa-icon.with("\u{e831}")
#let fa-kettlebell = fa-icon.with("\u{e832}")
#let fa-supportnow = fa-icon.with("\u{e833}")
#let fa-foot-wing = fa-icon.with("\u{e834}")
#let fa-pump-impeller = fa-icon.with("\u{e835}")
#let fa-arrow-rotate-left-10 = fa-icon.with("\u{e836}")
#let fa-arrow-rotate-right-10 = fa-icon.with("\u{e837}")
#let fa-tor-browser = fa-icon.with("\u{e838}")
#let fa-arrow-archery = fa-icon.with("\u{e839}")
#let fa-bow-archery = fa-icon.with("\u{e83a}")
#let fa-eye-closed = fa-icon.with("\u{e83b}")
#let fa-file-css = fa-icon.with("\u{e83c}")
#let fa-file-html = fa-icon.with("\u{e83d}")
#let fa-file-js = fa-icon.with("\u{e83e}")
#let fa-layer = fa-icon.with("\u{e83f}")
#let fa-typescript = fa-icon.with("\u{e840}")
#let fa-file-icns = fa-icon.with("\u{e841}")
#let fa-link-broken = fa-icon.with("\u{e842}")
#let fa-gpu = fa-icon.with("\u{e843}")
#let fa-square-deskpro = fa-icon.with("\u{e844}")
#let fa-aquarius = fa-icon.with("\u{e845}")
#let fa-aries = fa-icon.with("\u{e846}")
#let fa-cancer = fa-icon.with("\u{e847}")
#let fa-capricorn = fa-icon.with("\u{e848}")
#let fa-gemini = fa-icon.with("\u{e849}")
#let fa-leo = fa-icon.with("\u{e84a}")
#let fa-libra = fa-icon.with("\u{e84b}")
#let fa-pisces = fa-icon.with("\u{e84c}")
#let fa-sagittarius = fa-icon.with("\u{e84d}")
#let fa-scorpio = fa-icon.with("\u{e84e}")
#let fa-taurus = fa-icon.with("\u{e84f}")
#let fa-virgo = fa-icon.with("\u{e850}")
#let fa-circle-zulip = fa-icon.with("\u{e851}")
#let fa-julia = fa-icon.with("\u{e852}")
#let fa-zulip = fa-icon.with("\u{e853}")
#let fa-unison = fa-icon.with("\u{e854}")
#let fa-bgg = fa-icon.with("\u{e855}")
#let fa-board-game-geek = fa-icon.with("\u{e855}")
#let fa-ko-fi = fa-icon.with("\u{e856}")
#let fa-kubernetes = fa-icon.with("\u{e857}")
#let fa-postgresql = fa-icon.with("\u{e858}")
#let fa-scaleway = fa-icon.with("\u{e859}")
#let fa-venmo = fa-icon.with("\u{e85a}")
#let fa-venmo-v = fa-icon.with("\u{e85b}")
#let fa-unreal-engine = fa-icon.with("\u{e85c}")
#let fa-globaleaks = fa-icon.with("\u{e85d}")
#let fa-solana = fa-icon.with("\u{e85e}")
#let fa-threema = fa-icon.with("\u{e85f}")
#let fa-forgejo = fa-icon.with("\u{e860}")
#let fa-claude = fa-icon.with("\u{e861}")
#let fa-bicep = fa-icon.with("\u{e862}")
#let fa-gitee = fa-icon.with("\u{e863}")
#let fa-xmpp = fa-icon.with("\u{e864}")
#let fa-fediverse = fa-icon.with("\u{e865}")
#let fa-tailwind-css = fa-icon.with("\u{e866}")
#let fa-arch-linux = fa-icon.with("\u{e867}")
#let fa-svelte = fa-icon.with("\u{e868}")
#let fa-hugging-face = fa-icon.with("\u{e869}")
#let fa-leetcode = fa-icon.with("\u{e86a}")
#let fa-openstreetmap = fa-icon.with("\u{e86b}")
#let fa-rectangle-irc = fa-icon.with("\u{e86c}")
#let fa-ultralytics = fa-icon.with("\u{e86d}")
#let fa-ultralytics-hub = fa-icon.with("\u{e86e}")
#let fa-ultralytics-yolo = fa-icon.with("\u{e86f}")
#let fa-moon-first-quarter = fa-icon.with("\u{e870}")
#let fa-moon-last-quarter-inverse = fa-icon.with("\u{e870}")
#let fa-moon-full = fa-icon.with("\u{e871}")
#let fa-moon-new-inverse = fa-icon.with("\u{e871}")
#let fa-moon-first-quarter-inverse = fa-icon.with("\u{e872}")
#let fa-moon-last-quarter = fa-icon.with("\u{e872}")
#let fa-moon-full-inverse = fa-icon.with("\u{e873}")
#let fa-moon-new = fa-icon.with("\u{e873}")
#let fa-moon-waning-crescent = fa-icon.with("\u{e874}")
#let fa-moon-waxing-gibbous-inverse = fa-icon.with("\u{e874}")
#let fa-moon-waning-gibbous = fa-icon.with("\u{e875}")
#let fa-moon-waxing-crescent-inverse = fa-icon.with("\u{e875}")
#let fa-moon-waning-gibbous-inverse = fa-icon.with("\u{e876}")
#let fa-moon-waxing-crescent = fa-icon.with("\u{e876}")
#let fa-moon-waning-crescent-inverse = fa-icon.with("\u{e877}")
#let fa-moon-waxing-gibbous = fa-icon.with("\u{e877}")
#let fa-burst-new = fa-icon.with("\u{e878}")
#let fa-obsidian = fa-icon.with("\u{e879}")
#let fa-rectangle-new = fa-icon.with("\u{e87a}")
#let fa-zoom = fa-icon.with("\u{e87b}")
#let fa-opossum = fa-icon.with("\u{e87c}")
#let fa-possum = fa-icon.with("\u{e87c}")
#let fa-input-password = fa-icon.with("\u{e87d}")
#let fa-desk = fa-icon.with("\u{e87e}")
#let fa-dresser = fa-icon.with("\u{e87f}")
#let fa-stool = fa-icon.with("\u{e880}")
#let fa-wardrobe = fa-icon.with("\u{e881}")
#let fa-table-dining = fa-icon.with("\u{e882}")
#let fa-chest-drawers = fa-icon.with("\u{e883}")
#let fa-oar = fa-icon.with("\u{e884}")
#let fa-oars = fa-icon.with("\u{e885}")
#let fa-arrow-rotate-left-15 = fa-icon.with("\u{e886}")
#let fa-arrow-rotate-left-30 = fa-icon.with("\u{e887}")
#let fa-arrow-rotate-right-15 = fa-icon.with("\u{e888}")
#let fa-arrow-rotate-right-30 = fa-icon.with("\u{e889}")
#let fa-vim = fa-icon.with("\u{e88a}")
#let fa-rows-3 = fa-icon.with("\u{e88b}")
#let fa-table-cells-merge = fa-icon.with("\u{e88c}")
#let fa-table-cells-split = fa-icon.with("\u{e88d}")
#let fa-table-columns-add-after = fa-icon.with("\u{e88e}")
#let fa-table-columns-add-before = fa-icon.with("\u{e88f}")
#let fa-table-columns-merge-next = fa-icon.with("\u{e890}")
#let fa-table-columns-merge-previous = fa-icon.with("\u{e891}")
#let fa-table-columns-remove-after = fa-icon.with("\u{e892}")
#let fa-table-columns-remove-before = fa-icon.with("\u{e893}")
#let fa-table-rows-add-above = fa-icon.with("\u{e894}")
#let fa-table-rows-add-below = fa-icon.with("\u{e895}")
#let fa-table-rows-merge-next = fa-icon.with("\u{e896}")
#let fa-table-rows-merge-previous = fa-icon.with("\u{e897}")
#let fa-table-rows-remove-above = fa-icon.with("\u{e898}")
#let fa-table-rows-remove-below = fa-icon.with("\u{e899}")
#let fa-table-slash = fa-icon.with("\u{e89a}")
#let fa-kayak = fa-icon.with("\u{e89b}")
#let fa-canoe-person = fa-icon.with("\u{e89c}")
#let fa-utility-can = fa-icon.with("\u{e89d}")
#let fa-table-bar = fa-icon.with("\u{e89e}")
#let fa-owl = fa-icon.with("\u{e89f}")
#let fa-rectangle-api = fa-icon.with("\u{e8a0}")
#let fa-nas = fa-icon.with("\u{e8a1}")
#let fa-poker-chip = fa-icon.with("\u{e8a2}")
#let fa-tower-receive = fa-icon.with("\u{e8a3}")
#let fa-gear-api = fa-icon.with("\u{e8a4}")
#let fa-gear-complex-api = fa-icon.with("\u{e8a5}")
#let fa-globe-www = fa-icon.with("\u{e8a6}")
#let fa-label = fa-icon.with("\u{e8a7}")
#let fa-rectangle-n-a = fa-icon.with("\u{e8a8}")
#let fa-remote = fa-icon.with("\u{e8a9}")
#let fa-image-broken = fa-icon.with("\u{e8aa}")
#let fa-symfonycasts = fa-icon.with("\u{e8ab}")
#let fa-build-awesome = fa-icon.with("\u{e8ac}")
#let fa-codeberg = fa-icon.with("\u{e8ad}")
#let fa-devpost = fa-icon.with("\u{e8ae}")
#let fa-envelope-heart = fa-icon.with("\u{e8af}")
#let fa-internet-archive = fa-icon.with("\u{e8b1}")
#let fa-lets-encrypt = fa-icon.with("\u{e8b2}")
#let fa-matrix = fa-icon.with("\u{e8b3}")
#let fa-mattermost = fa-icon.with("\u{e8b4}")
#let fa-nextcloud = fa-icon.with("\u{e8b5}")
#let fa-roblox-creator-studio = fa-icon.with("\u{e8b6}")
#let fa-square-build-awesome-stroke = fa-icon.with("\u{e8b7}")
#let fa-substack = fa-icon.with("\u{e8b8}")
#let fa-tesla = fa-icon.with("\u{e8b9}")
#let fa-xrp = fa-icon.with("\u{e8ba}")
#let fa-xrpl = fa-icon.with("\u{e8bb}")
#let fa-youtube-shorts = fa-icon.with("\u{e8bc}")
#let fa-ror = fa-icon.with("\u{e8bd}")
#let fa-visual-studio = fa-icon.with("\u{e8be}")
#let fa-dolibarr = fa-icon.with("\u{e8bf}")
#let fa-obs-studio = fa-icon.with("\u{e8c0}")
#let fa-storybook = fa-icon.with("\u{e8c1}")
#let fa-a11y-project = fa-icon.with("\u{e8c2}")
#let fa-Suricata = fa-icon.with("\u{e8c4}")
#let fa-meerkat = fa-icon.with("\u{e8c4}")
#let fa-suricate = fa-icon.with("\u{e8c4}")
#let fa-suricatta = fa-icon.with("\u{e8c4}")
#let fa-file-md = fa-icon.with("\u{e8c5}")
#let fa-file-txt = fa-icon.with("\u{e8c6}")
#let fa-copilot = fa-icon.with("\u{e8c7}")
...
#let fa-lotus = fa-icon.with("\u{f5bb}")
