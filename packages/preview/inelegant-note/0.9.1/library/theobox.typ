...
/* 各种盒子函数-showybox */
// 公理
#let (axiom-counter, axiombox-showy, axiom-showy, show-my-axiom) = make-frame(
  "axiom",
  axiom-sty.name,
  inherited-levels: 1,
...
// 定义
#let (definition-counter, definitionbox-showy, definition-showy, show-my-definition) = make-frame(
  "definition",
  definition-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 定律
#let (law-counter, lawbox-showy, law-showy, show-my-law) = make-frame(
  "law",
  law-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 定理
#let (theorem-counter, theorembox-showy, theorem-showy, show-my-theorem) = make-frame(
  "theorem",
  theorem-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 引理
#let (lemma-counter, lemmabox-showy, lemma-showy, show-my-lemma) = make-frame(
  "lemma",
  lemma-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 假设
#let (postulate-counter, postulatebox-showy, postulate-showy, show-my-postulate) = make-frame(
  "postulate",
  postulate-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 推论
#let (corollary-counter, corollarybox-showy, corollary-showy, show-my-corollary) = make-frame(
  "corollary",
  corollary-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 命题
#let (proposition-counter, propositionbox-showy, proposition-showy, show-my-proposition) = make-frame(
  "proposition",
...
// 例子
#let (example-counter, examplebox-showy, example-showy, show-my-example) = make-frame(
  "example",
  example-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
// 练习
#let (exercise-counter, exercisebox-showy, exercise-showy, show-my-exercise) = make-frame(
  "exercise",
  exercise-sty.name,
  inherited-levels: 1,
  render: my-fancy-box.with(
...
/* 各种盒子函数-rainbow */
// 公理
#let (axiom-counter, axiombox-rainbow, axiom-rainbow, show-my-axiom) = make-frame(
  "axiom",
  axiom-sty.name,
  inherited-levels: 1,
...
// 定义
#let (definition-counter, definitionbox-rainbow, definition-rainbow, show-my-definition) = make-frame(
  "definition",
  definition-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 定律
#let (law-counter, lawbox-rainbow, law-rainbow, show-my-law) = make-frame(
  "law",
  law-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 定理
#let (theorem-counter, theorembox-rainbow, theorem-rainbow, show-my-theorem) = make-frame(
  "theorem",
  theorem-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 引理
#let (lemma-counter, lemmabox-rainbow, lemma-rainbow, show-my-lemma) = make-frame(
  "lemma",
  lemma-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 假设
#let (postulate-counter, postulatebox-rainbow, postulate-rainbow, show-my-postulate) = make-frame(
  "postulate",
  postulate-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 推论
#let (corollary-counter, corollarybox-rainbow, corollary-rainbow, show-my-corollary) = make-frame(
  "corollary",
  corollary-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 命题
#let (proposition-counter, propositionbox-rainbow, proposition-rainbow, show-my-proposition) = make-frame(
  "proposition",
  proposition-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 例子
#let (example-counter, examplebox-rainbow, example-rainbow, show-my-example) = make-frame(
  "example",
  example-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
// 练习
#let (exercise-counter, exercisebox-rainbow, exercise-rainbow, show-my-exercise) = make-frame(
  "exercise",
  exercise-sty.name,
  inherited-levels: 1,
  render: my-rainbow.with(
...
#let my-show-theorion(body) = {
  show: show-my-axiom
  show: show-my-definition
  show: show-my-law
  show: show-my-theorem
  show: show-my-lemma
  show: show-my-postulate
  show: show-my-corollary
  show: show-my-proposition
  show: show-my-exercise
  show: show-my-example
