...
![Web App 中选择模板](imgs/choose_template.webp)
![在线编辑](imgs/webapp_edit.webp)
...
![VSCode 编辑](imgs/vscode_edit.webp)
...
从 GitHub 克隆并作为本地包安装，便于在多个项目中复用（可参考 [Typst 文档](https://github.com/typst/packages)）：
