...
#import "utils/choiceQuestion.typ": choiceQuestion
#import "utils/fillQuestion.typ": fillQuestion
#import "utils/trueFalseQuestion.typ": trueFalseQuestion
...
#let documentclass(
  ...
  return (
    ...
    choiceQuestion: questions => choiceQuestion(
      seed: seed,
      random: random,
      questions: questions,
    ...
    fillQuestion: (questions, ..args) => fillQuestion(
      seed: seed,
      random: random,
      questions: questions,
      font-size: font-size,
    ...
    trueFalseQuestion: (questions, ..args) => trueFalseQuestion(
      seed: seed,
      random: random,
      questions: questions,
      font-size: font-size,
