...
- The **dark** and **light color** control the look of the QR code. Set it to some [typst-color](https://typst.app/docs/reference/visualize/color/) or hex string like in the example above or leave it to get a standard black and white QR code.
...
```typst
#import "@preview/rustycure:0.2.0": qr-code, qr-svg
