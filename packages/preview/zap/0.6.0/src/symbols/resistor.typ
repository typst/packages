...
/// Resistor symbol to use inside a circuit
///
/// - name (str): symbole unique identifier
/// - node (coordinate): symbol position coordinates
/// - variable (bool): displays a diagonal arrow
/// - heatable (bool): transform to heater device
/// - adjustable (bool): display an orthogonal arrow
/// - preset (bool): display a diagonal arrow with flat tip
/// - sensor (bool): display a diagonal arrow with flat line
/// -> content
