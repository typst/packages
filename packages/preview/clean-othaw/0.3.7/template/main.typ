#import "@preview/clean-othaw:0.3.7": *
#import "glossary.typ": glossary-entries
#import "anhang.typ": anhang
...
#show: clean-othaw.with(
  ...
  authors: (
    (name: "Max Mustermann", student-id: "7654321", course-of-studies: "Educational Technology",/*signature:image("assets/Unterschrift.png"),*/ company: (
      (name: "ABC GmbH", post-code: "92224", city: "Amberg")
    )),
...
//      )),
  ...
  abstract-text: lorem(120),
  keywords: "Typst, OTH, Lernen",
  at-university: false, // if true the company name on the title page and the confidentiality statement are hidden
  bibliography: bibliography("sources.bib"),
  glossary: glossary-entries, // displays the glossary terms defined in "glossary.typ"
  appendix: anhang, //displays the appendix defined in "anhang.typ"
  appendix-name: "A.",
  language: "de", // en, de
  bib-style: "ieee", //ieee, apa
  supervisor: (company: "John Appleseed", university-first: "Prof. Dr. Daniel Düsentrieb", university-second: "Prof. Dr. Katharina Toll",),
  university: "Ostbayerische Technische Hochschule Amberg-Weiden",
  university-location: "Amberg",
  university-short: "OTH AW",
  faculty: "Fakultät Elektrotechnik, Medien und Informatik",
  show-confidentiality-statement: false,
  formalities-in-frontmatter: true, //default: true, if set to false the formalities are moved to appendix and the frontmatter is reduced
