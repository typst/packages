...
[![Typst Package](https://img.shields.io/badge/Typst-Package-239DAD)](https://typst.app/universe/package/sjtu-doctoral-annual-progress)
...
3. 搜索框输入 `sjtu-doctoral-annual-progress`
...
3. 在模板库中搜索 `sjtu-doctoral-annual-progress`
