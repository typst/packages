...
#figure(
  image(
    "../template/img/AlbertEinstein.png",
    width: 50%,
  ),
  // kind: "image", 被弃用的特性
  supplement: [图],
...
#tablex(
  ...
  figure(
    image(
      "../template/img/ClaudeElwoodShannon.png",
      width: 50%,
    ),
    supplement: [图],
  ),
  figure(
    image(
      "../template/img/John von Neumann.png",
      width: 50%,
    ),
    supplement: [图],
  ),
...
// 文献引用
#bib(bibfunc: bibliography("../template/ref.bib"))
...
#figure(
  image(
    "./../template/img/appendix/Lenna.png",
    width: 70%,
  ),
  kind: "appendix",
  supplement: [附图],
...
#figure(
  image(
    "./../template/img/appendix/Sierpinski_pyramid.jpg",
    width: 70%,
  ),
  kind: "appendix",
  supplement: [附图],
...
#figure(
  image(
    "./../template/img/appendix/Sigmoid.svg",
    width: 100%,
  ),
  kind: "appendix",
  supplement: [附图],
