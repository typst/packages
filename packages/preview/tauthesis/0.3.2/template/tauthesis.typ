...
#import "meta.typ"
#import "content/abstract.typ"
#import "content/tiivistelmä.typ"
...
#let titlepage() = {
	...
	place(top + left, float:true, dx: -2cm, dy:-2cm, image("images/tau-logo-fin-eng.svg", width : 8cm))
...
#let preface() = {
	...
	let text = include "content/preface.typ"
...
#let tauthesis(
	...
	let abstracttext = include "content/abstract.typ"

	let tiivistelmäteksti = include "content/tiivistelmä.typ"
