...
2. 按下 `Ctrl + Shift + P`(Windows) / `Command + Shift + P`(MacOS) 打开命令界面，输入 `Typst: Initialize a New Typst Project based on a Template` 并回车，选择 `@preview/modern-sjtu-report:0.2.0`，选择一个空文件夹作为项目目录，随后就可以开始编辑了。

### 使用命令行

1. 下载并安装 [Typst Complier](https://typst.app/open-source/#download)。

2. 使用命令 `typst init @preview/modern-sjtu-report:0.2.0` 初始化项目
...
项目采用Unlicense License，属于公有领域。项目中使用的第三方包[lovelace](https://github.com/andreasKroepelin/lovelace), [cuti](https://github.com/csimide/cuti), [lilaq](https://github.com/lilaq-project/lilaq)采用MIT License。
