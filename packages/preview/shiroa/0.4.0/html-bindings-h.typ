...
#let html(body, manifest: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if manifest != none {attrs.insert("manifest", manifest)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("html", attrs: attrs, body)}
...
#let head(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("head", attrs: attrs, body)}
...
#let title(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("title", attrs: attrs, body)}
...
#let base(body, href: none, target: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if href != none {attrs.insert("href", href)};if target != none {attrs.insert("target", target)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("base", attrs: attrs, body)}
...
#let link(body, href: none, crossorigin: none, rel: none, media: none, hreflang: none, type: none, sizes: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if href != none {attrs.insert("href", href)};if crossorigin != none {attrs.insert("crossorigin", crossorigin)};if rel != none {attrs.insert("rel", rel)};if media != none {attrs.insert("media", media)};if hreflang != none {attrs.insert("hreflang", hreflang)};if type != none {attrs.insert("type", type)};if sizes != none {attrs.insert("sizes", sizes)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("link", attrs: attrs, body)}
...
#let meta(body, name: none, http-equiv: none, content: none, charset: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if name != none {attrs.insert("name", name)};if http-equiv != none {attrs.insert("http-equiv", http-equiv)};if content != none {attrs.insert("content", content)};if charset != none {attrs.insert("charset", charset)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("meta", attrs: attrs, body)}
...
#let style(body, media: none, nonce: none, type: none, scoped: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if media != none {attrs.insert("media", media)};if nonce != none {attrs.insert("nonce", nonce)};if type != none {attrs.insert("type", type)};if scoped != none {attrs.insert("scoped", scoped)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("style", attrs: attrs, body)}
...
#let body(body, onafterprint: none, onbeforeprint: none, onbeforeunload: none, onhashchange: none, onlanguagechange: none, onmessage: none, onoffline: none, ononline: none, onpagehide: none, onpageshow: none, onpopstate: none, onstorage: none, onunload: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if onafterprint != none {attrs.insert("onafterprint", onafterprint)};if onbeforeprint != none {attrs.insert("onbeforeprint", onbeforeprint)};if onbeforeunload != none {attrs.insert("onbeforeunload", onbeforeunload)};if onhashchange != none {attrs.insert("onhashchange", onhashchange)};if onlanguagechange != none {attrs.insert("onlanguagechange", onlanguagechange)};if onmessage != none {attrs.insert("onmessage", onmessage)};if onoffline != none {attrs.insert("onoffline", onoffline)};if ononline != none {attrs.insert("ononline", ononline)};if onpagehide != none {attrs.insert("onpagehide", onpagehide)};if onpageshow != none {attrs.insert("onpageshow", onpageshow)};if onpopstate != none {attrs.insert("onpopstate", onpopstate)};if onstorage != none {attrs.insert("onstorage", onstorage)};if onunload != none {attrs.insert("onunload", onunload)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("body", attrs: attrs, body)}
...
#let article(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("article", attrs: attrs, body)}
...
#let section(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("section", attrs: attrs, body)}
...
#let nav(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("nav", attrs: attrs, body)}
...
#let aside(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("aside", attrs: attrs, body)}
...
#let h1(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h1", attrs: attrs, body)}
...
#let h2(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h2", attrs: attrs, body)}
...
#let h3(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h3", attrs: attrs, body)}
...
#let h4(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h4", attrs: attrs, body)}
...
#let h5(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h5", attrs: attrs, body)}
...
#let h6(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("h6", attrs: attrs, body)}
...
#let header(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("header", attrs: attrs, body)}
...
#let footer(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("footer", attrs: attrs, body)}
...
#let address(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("address", attrs: attrs, body)}
...
#let p(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("p", attrs: attrs, body)}
...
#let hr(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("hr", attrs: attrs, body)}
...
#let pre(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("pre", attrs: attrs, body)}
...
#let blockquote(body, cite: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if cite != none {attrs.insert("cite", cite)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("blockquote", attrs: attrs, body)}
...
#let ol(body, reversed: none, start: none, type: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if reversed != none {attrs.insert("reversed", reversed)};if start != none {attrs.insert("start", start)};if type != none {attrs.insert("type", type)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("ol", attrs: attrs, body)}
...
#let ul(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("ul", attrs: attrs, body)}
...
#let li(body, value: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if value != none {attrs.insert("value", value)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("li", attrs: attrs, body)}
...
#let dl(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("dl", attrs: attrs, body)}
...
#let dt(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("dt", attrs: attrs, body)}
...
#let dd(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("dd", attrs: attrs, body)}
...
#let figure(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("figure", attrs: attrs, body)}
...
#let figcaption(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("figcaption", attrs: attrs, body)}
...
#let main(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("main", attrs: attrs, body)}
...
#let div(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("div", attrs: attrs, body)}
...
#let a(body, href: none, target: none, download: none, ping: none, rel: none, hreflang: none, type: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if href != none {attrs.insert("href", href)};if target != none {attrs.insert("target", target)};if download != none {attrs.insert("download", download)};if ping != none {attrs.insert("ping", ping)};if rel != none {attrs.insert("rel", rel)};if hreflang != none {attrs.insert("hreflang", hreflang)};if type != none {attrs.insert("type", type)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("a", attrs: attrs, body)}
...
#let em(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("em", attrs: attrs, body)}
...
#let strong(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("strong", attrs: attrs, body)}
...
#let small(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("small", attrs: attrs, body)}
...
#let s(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("s", attrs: attrs, body)}
...
#let cite(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("cite", attrs: attrs, body)}
...
#let q(body, cite: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if cite != none {attrs.insert("cite", cite)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("q", attrs: attrs, body)}
...
#let dfn(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("dfn", attrs: attrs, body)}
...
#let abbr(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("abbr", attrs: attrs, body)}
...
#let ruby(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("ruby", attrs: attrs, body)}
...
#let rb(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("rb", attrs: attrs, body)}
...
#let rt(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("rt", attrs: attrs, body)}
...
#let rp(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("rp", attrs: attrs, body)}
...
#let time(body, datetime: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if datetime != none {attrs.insert("datetime", datetime)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("time", attrs: attrs, body)}
...
#let code(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("code", attrs: attrs, body)}
...
#let var(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("var", attrs: attrs, body)}
...
#let samp(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("samp", attrs: attrs, body)}
...
#let kbd(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("kbd", attrs: attrs, body)}
...
#let sub(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("sub", attrs: attrs, body)}
...
#let sup(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("sup", attrs: attrs, body)}
...
#let i(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("i", attrs: attrs, body)}
...
#let b(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("b", attrs: attrs, body)}
...
#let u(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("u", attrs: attrs, body)}
...
#let mark(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("mark", attrs: attrs, body)}
...
#let bdi(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("bdi", attrs: attrs, body)}
...
#let bdo(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("bdo", attrs: attrs, body)}
...
#let span(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("span", attrs: attrs, body)}
...
#let br(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("br", attrs: attrs, body)}
...
#let wbr(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("wbr", attrs: attrs, body)}
...
#let ins(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("ins", attrs: attrs, body)}
...
#let del(body, cite: none, datetime: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if cite != none {attrs.insert("cite", cite)};if datetime != none {attrs.insert("datetime", datetime)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("del", attrs: attrs, body)}
...
#let picture(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("picture", attrs: attrs, body)}
...
#let img(body, alt: none, src: none, srcset: none, crossorigin: none, usemap: none, ismap: none, width: none, height: none, decoding: none, loading: none, fetchpriority: none, referrerpolicy: none, sizes: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if alt != none {attrs.insert("alt", alt)};if src != none {attrs.insert("src", src)};if srcset != none {attrs.insert("srcset", srcset)};if crossorigin != none {attrs.insert("crossorigin", crossorigin)};if usemap != none {attrs.insert("usemap", usemap)};if ismap != none {attrs.insert("ismap", ismap)};if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if decoding != none {attrs.insert("decoding", decoding)};if loading != none {attrs.insert("loading", loading)};if fetchpriority != none {attrs.insert("fetchpriority", fetchpriority)};if referrerpolicy != none {attrs.insert("referrerpolicy", referrerpolicy)};if sizes != none {attrs.insert("sizes", sizes)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("img", attrs: attrs, body)}
...
#let iframe(body, src: none, srcdoc: none, name: none, sandbox: none, seamless: none, allowfullscreen: none, width: none, height: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if srcdoc != none {attrs.insert("srcdoc", srcdoc)};if name != none {attrs.insert("name", name)};if sandbox != none {attrs.insert("sandbox", sandbox)};if seamless != none {attrs.insert("seamless", seamless)};if allowfullscreen != none {attrs.insert("allowfullscreen", allowfullscreen)};if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("iframe", attrs: attrs, body)}
...
#let embed(body, src: none, type: none, width: none, height: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if type != none {attrs.insert("type", type)};if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("embed", attrs: attrs, body)}
...
#let object(body, data: none, type: none, typemustmatch: none, name: none, usemap: none, form: none, width: none, height: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if data != none {attrs.insert("data", data)};if type != none {attrs.insert("type", type)};if typemustmatch != none {attrs.insert("typemustmatch", typemustmatch)};if name != none {attrs.insert("name", name)};if usemap != none {attrs.insert("usemap", usemap)};if form != none {attrs.insert("form", form)};if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("object", attrs: attrs, body)}
...
#let param(body, name: none, value: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if name != none {attrs.insert("name", name)};if value != none {attrs.insert("value", value)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("param", attrs: attrs, body)}
...
#let video(body, src: none, crossorigin: none, poster: none, preload: none, autoplay: none, mediagroup: none, loop: none, muted: none, controls: none, width: none, height: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if crossorigin != none {attrs.insert("crossorigin", crossorigin)};if poster != none {attrs.insert("poster", poster)};if preload != none {attrs.insert("preload", preload)};if autoplay != none {attrs.insert("autoplay", autoplay)};if mediagroup != none {attrs.insert("mediagroup", mediagroup)};if loop != none {attrs.insert("loop", loop)};if muted != none {attrs.insert("muted", muted)};if controls != none {attrs.insert("controls", controls)};if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("video", attrs: attrs, body)}
...
#let audio(body, src: none, crossorigin: none, preload: none, autoplay: none, mediagroup: none, loop: none, muted: none, controls: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if crossorigin != none {attrs.insert("crossorigin", crossorigin)};if preload != none {attrs.insert("preload", preload)};if autoplay != none {attrs.insert("autoplay", autoplay)};if mediagroup != none {attrs.insert("mediagroup", mediagroup)};if loop != none {attrs.insert("loop", loop)};if muted != none {attrs.insert("muted", muted)};if controls != none {attrs.insert("controls", controls)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("audio", attrs: attrs, body)}
...
#let source(body, src: none, type: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if type != none {attrs.insert("type", type)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("source", attrs: attrs, body)}
...
#let track(body, default: none, kind: none, label: none, src: none, srclang: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if default != none {attrs.insert("default", default)};if kind != none {attrs.insert("kind", kind)};if label != none {attrs.insert("label", label)};if src != none {attrs.insert("src", src)};if srclang != none {attrs.insert("srclang", srclang)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("track", attrs: attrs, body)}
...
#let map(body, name: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if name != none {attrs.insert("name", name)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("map", attrs: attrs, body)}
...
#let area(body, alt: none, coords: none, shape: none, href: none, target: none, download: none, ping: none, rel: none, hreflang: none, type: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if alt != none {attrs.insert("alt", alt)};if coords != none {attrs.insert("coords", coords)};if shape != none {attrs.insert("shape", shape)};if href != none {attrs.insert("href", href)};if target != none {attrs.insert("target", target)};if download != none {attrs.insert("download", download)};if ping != none {attrs.insert("ping", ping)};if rel != none {attrs.insert("rel", rel)};if hreflang != none {attrs.insert("hreflang", hreflang)};if type != none {attrs.insert("type", type)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("area", attrs: attrs, body)}
...
#let table(body, border: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if border != none {attrs.insert("border", border)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("table", attrs: attrs, body)}
...
#let caption(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("caption", attrs: attrs, body)}
...
#let colgroup(body, span: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if span != none {attrs.insert("span", span)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("colgroup", attrs: attrs, body)}
...
#let col(body, span: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if span != none {attrs.insert("span", span)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("col", attrs: attrs, body)}
...
#let tbody(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("tbody", attrs: attrs, body)}
...
#let thead(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("thead", attrs: attrs, body)}
...
#let tfoot(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("tfoot", attrs: attrs, body)}
...
#let tr(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("tr", attrs: attrs, body)}
...
#let td(body, colspan: none, rowspan: none, headers: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if colspan != none {attrs.insert("colspan", colspan)};if rowspan != none {attrs.insert("rowspan", rowspan)};if headers != none {attrs.insert("headers", headers)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("td", attrs: attrs, body)}
...
#let th(body, colspan: none, rowspan: none, headers: none, scope: none, sorted: none, abbr: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if colspan != none {attrs.insert("colspan", colspan)};if rowspan != none {attrs.insert("rowspan", rowspan)};if headers != none {attrs.insert("headers", headers)};if scope != none {attrs.insert("scope", scope)};if sorted != none {attrs.insert("sorted", sorted)};if abbr != none {attrs.insert("abbr", abbr)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("th", attrs: attrs, body)}
...
#let form(body, accept-charset: none, action: none, autocomplete: none, enctype: none, method: none, name: none, novalidate: none, target: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if accept-charset != none {attrs.insert("accept-charset", accept-charset)};if action != none {attrs.insert("action", action)};if autocomplete != none {attrs.insert("autocomplete", autocomplete)};if enctype != none {attrs.insert("enctype", enctype)};if method != none {attrs.insert("method", method)};if name != none {attrs.insert("name", name)};if novalidate != none {attrs.insert("novalidate", novalidate)};if target != none {attrs.insert("target", target)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("form", attrs: attrs, body)}
...
#let label(body, form: none, x-for: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if form != none {attrs.insert("form", form)};if x-for != none {attrs.insert("for", x-for)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("label", attrs: attrs, body)}
...
#let input(body, accept: none, alt: none, autocomplete: none, autofocus: none, checked: none, dirname: none, disabled: none, form: none, formaction: none, formenctype: none, formmethod: none, formnovalidate: none, formtarget: none, height: none, inputmode: none, list: none, max: none, maxlength: none, min: none, minlength: none, multiple: none, name: none, pattern: none, placeholder: none, popovertarget: none, popovertargetaction: none, readonly: none, required: none, size: none, src: none, step: none, type: none, value: none, width: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if accept != none {attrs.insert("accept", accept)};if alt != none {attrs.insert("alt", alt)};if autocomplete != none {attrs.insert("autocomplete", autocomplete)};if autofocus != none {attrs.insert("autofocus", autofocus)};if checked != none {attrs.insert("checked", checked)};if dirname != none {attrs.insert("dirname", dirname)};if disabled != none {attrs.insert("disabled", disabled)};if form != none {attrs.insert("form", form)};if formaction != none {attrs.insert("formaction", formaction)};if formenctype != none {attrs.insert("formenctype", formenctype)};if formmethod != none {attrs.insert("formmethod", formmethod)};if formnovalidate != none {attrs.insert("formnovalidate", formnovalidate)};if formtarget != none {attrs.insert("formtarget", formtarget)};if height != none {attrs.insert("height", height)};if inputmode != none {attrs.insert("inputmode", inputmode)};if list != none {attrs.insert("list", list)};if max != none {attrs.insert("max", max)};if maxlength != none {attrs.insert("maxlength", maxlength)};if min != none {attrs.insert("min", min)};if minlength != none {attrs.insert("minlength", minlength)};if multiple != none {attrs.insert("multiple", multiple)};if name != none {attrs.insert("name", name)};if pattern != none {attrs.insert("pattern", pattern)};if placeholder != none {attrs.insert("placeholder", placeholder)};if popovertarget != none {attrs.insert("popovertarget", popovertarget)};if popovertargetaction != none {attrs.insert("popovertargetaction", popovertargetaction)};if readonly != none {attrs.insert("readonly", readonly)};if required != none {attrs.insert("required", required)};if size != none {attrs.insert("size", size)};if src != none {attrs.insert("src", src)};if step != none {attrs.insert("step", step)};if type != none {attrs.insert("type", type)};if value != none {attrs.insert("value", value)};if width != none {attrs.insert("width", width)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("input", attrs: attrs, body)}
...
#let button(body, autofocus: none, disabled: none, form: none, formaction: none, formenctype: none, formmethod: none, formnovalidate: none, formtarget: none, name: none, popovertarget: none, popovertargetaction: none, type: none, value: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if autofocus != none {attrs.insert("autofocus", autofocus)};if disabled != none {attrs.insert("disabled", disabled)};if form != none {attrs.insert("form", form)};if formaction != none {attrs.insert("formaction", formaction)};if formenctype != none {attrs.insert("formenctype", formenctype)};if formmethod != none {attrs.insert("formmethod", formmethod)};if formnovalidate != none {attrs.insert("formnovalidate", formnovalidate)};if formtarget != none {attrs.insert("formtarget", formtarget)};if name != none {attrs.insert("name", name)};if popovertarget != none {attrs.insert("popovertarget", popovertarget)};if popovertargetaction != none {attrs.insert("popovertargetaction", popovertargetaction)};if type != none {attrs.insert("type", type)};if value != none {attrs.insert("value", value)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("button", attrs: attrs, body)}
...
#let select(body, autocomplete: none, autofocus: none, disabled: none, form: none, multiple: none, name: none, required: none, size: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if autocomplete != none {attrs.insert("autocomplete", autocomplete)};if autofocus != none {attrs.insert("autofocus", autofocus)};if disabled != none {attrs.insert("disabled", disabled)};if form != none {attrs.insert("form", form)};if multiple != none {attrs.insert("multiple", multiple)};if name != none {attrs.insert("name", name)};if required != none {attrs.insert("required", required)};if size != none {attrs.insert("size", size)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("select", attrs: attrs, body)}
...
#let datalist(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("datalist", attrs: attrs, body)}
...
#let optgroup(body, disabled: none, label: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if disabled != none {attrs.insert("disabled", disabled)};if label != none {attrs.insert("label", label)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("optgroup", attrs: attrs, body)}
...
#let option(body, disabled: none, label: none, selected: none, value: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if disabled != none {attrs.insert("disabled", disabled)};if label != none {attrs.insert("label", label)};if selected != none {attrs.insert("selected", selected)};if value != none {attrs.insert("value", value)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("option", attrs: attrs, body)}
...
#let textarea(body, autocomplete: none, autofocus: none, cols: none, dirname: none, disabled: none, form: none, inputmode: none, maxlength: none, minlength: none, name: none, placeholder: none, readonly: none, required: none, rows: none, wrap: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if autocomplete != none {attrs.insert("autocomplete", autocomplete)};if autofocus != none {attrs.insert("autofocus", autofocus)};if cols != none {attrs.insert("cols", cols)};if dirname != none {attrs.insert("dirname", dirname)};if disabled != none {attrs.insert("disabled", disabled)};if form != none {attrs.insert("form", form)};if inputmode != none {attrs.insert("inputmode", inputmode)};if maxlength != none {attrs.insert("maxlength", maxlength)};if minlength != none {attrs.insert("minlength", minlength)};if name != none {attrs.insert("name", name)};if placeholder != none {attrs.insert("placeholder", placeholder)};if readonly != none {attrs.insert("readonly", readonly)};if required != none {attrs.insert("required", required)};if rows != none {attrs.insert("rows", rows)};if wrap != none {attrs.insert("wrap", wrap)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("textarea", attrs: attrs, body)}
...
#let output(body, x-for: none, form: none, name: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if x-for != none {attrs.insert("for", x-for)};if form != none {attrs.insert("form", form)};if name != none {attrs.insert("name", name)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("output", attrs: attrs, body)}
...
#let progress(body, value: none, max: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if value != none {attrs.insert("value", value)};if max != none {attrs.insert("max", max)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("progress", attrs: attrs, body)}
...
#let meter(body, value: none, min: none, max: none, low: none, high: none, optimum: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if value != none {attrs.insert("value", value)};if min != none {attrs.insert("min", min)};if max != none {attrs.insert("max", max)};if low != none {attrs.insert("low", low)};if high != none {attrs.insert("high", high)};if optimum != none {attrs.insert("optimum", optimum)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("meter", attrs: attrs, body)}
...
#let fieldset(body, disabled: none, form: none, name: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if disabled != none {attrs.insert("disabled", disabled)};if form != none {attrs.insert("form", form)};if name != none {attrs.insert("name", name)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("fieldset", attrs: attrs, body)}
...
#let legend(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("legend", attrs: attrs, body)}
...
#let details(body, open: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if open != none {attrs.insert("open", open)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("details", attrs: attrs, body)}
...
#let summary(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("summary", attrs: attrs, body)}
...
#let dialog(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("dialog", attrs: attrs, body)}
...
#let script(body, src: none, type: none, charset: none, async: none, defer: none, crossorigin: none, nonce: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if src != none {attrs.insert("src", src)};if type != none {attrs.insert("type", type)};if charset != none {attrs.insert("charset", charset)};if async != none {attrs.insert("async", async)};if defer != none {attrs.insert("defer", defer)};if crossorigin != none {attrs.insert("crossorigin", crossorigin)};if nonce != none {attrs.insert("nonce", nonce)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("script", attrs: attrs, body)}
...
#let noscript(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("noscript", attrs: attrs, body)}
...
#let template(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("template", attrs: attrs, body)}
...
#let canvas(body, width: none, height: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if width != none {attrs.insert("width", width)};if height != none {attrs.insert("height", height)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("canvas", attrs: attrs, body)}
...
#let slot(body, name: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if name != none {attrs.insert("name", name)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("slot", attrs: attrs, body)}
...
#let data(body, value: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if value != none {attrs.insert("value", value)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("data", attrs: attrs, body)}
...
#let hgroup(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("hgroup", attrs: attrs, body)}
...
#let menu(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("menu", attrs: attrs, body)}
...
#let search(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("search", attrs: attrs, body)}
...
#let fencedframe(body, allow: none, height: none, width: none, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if allow != none {attrs.insert("allow", allow)};if height != none {attrs.insert("height", height)};if width != none {attrs.insert("width", width)};if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("fencedframe", attrs: attrs, body)}
...
#let selectedcontent(body, class: none, id: none, style: none, ..attrs) = {assert(attrs.pos().len() == 0, message: "can have only one body");let attrs = attrs.named();if class != none {attrs.insert("class", class)};if id != none {attrs.insert("id", id)};if style != none {attrs.insert("style", style)};std.html.elem("selectedcontent", attrs: attrs, body)}
