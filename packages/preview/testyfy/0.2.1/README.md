...
```typst
#import "@preview/testyfy:0.2.1"
```

The available versions (in the example *0.2.1*) can be taken [from the releases][releases]. Now you
...
[f0]: https://gitlab.com/hartang/typst/testyfy/-/releases/0.2.1/downloads/docs.pdf
